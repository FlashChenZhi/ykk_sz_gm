DROP PROCEDURE AWC.RTASF0;

CREATE OR REPLACE PROCEDURE AWC.RTASF0
(
...
||	Date		:2007/11/1
||
||	Outline 	:Hansokey wo SAIBAN SURU
||
||	Argument	:IN		IN_NYUSYUKBN
||
||			 	 OUT
||
||			 	 IN OUT	IO_HANSOKEY		: Hansokey housing area
...
IS
	...
	==========================================================================================================================*/
	DEF_MYNAME		CONSTANT VARCHAR2	( 10) := 'RTASF0';
	DEF_MYNAMEJP	CONSTANT VARCHAR2	( 60) := 'Hansokey preparation';
...
BEGIN
	...
	/*======================================================================================================================
	||	Hansokey wo SYUTOKU SURU
	======================================================================================================================*/
	STASF0( IN_NYUSYUKBN, IO_HANSOKEY, IO_RC, IO_MSGDAT );
	IF IO_RC != 0 THEN
		IO_MSGNO	:=	IO_RC	;
