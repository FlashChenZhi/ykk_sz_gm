DROP PROCEDURE AWC.STOCKIN_3;

CREATE OR REPLACE PROCEDURE AWC.stockin_3 (
...
BEGIN
   ...
   THEN
      IF wk_station_no = '2101'
      THEN
         wk_end_station_no := '2102';
      ELSE
         wk_end_station_no := ' ';
      END IF;
      ...
      stockin_3_normality (in_schedule_no, io_return_code, io_return_message);
   ELSE
      IF wk_station_no = '2101'
      THEN
         wk_end_station_no := '2201';
      ELSE
         wk_end_station_no := ' ';
      END IF;
