DROP PROCEDURE AWC.NORMAL_STOCKOUT_START;

CREATE OR REPLACE PROCEDURE AWC.normal_stockout_start (
   ...
   IS
        SELECT   DISTINCT fngset.systemid, fnhanso.endstno
         ...
         WHERE   fngset.schno = c_schedule_no
                 ...
                 AND fnhanso.mckey = fngset.mckey
                 ...
                 AND fnsyotei.retrieval_station NOT IN
...
BEGIN
   ...
   THEN
      ...
      LOOP
         ...
         get_end_station_no (wk_fngset_row.retrieval_station,
                             fnhanso_list_iterator.sijisyosai,
                             wk_end_st,
                             io_return_code,
                             io_return_message);
         ...
         IF fnhanso_list_iterator.sijisyosai =
   ...
   LOOP
      ...
      normal_append_trans_data (in_schedule_no,
   ...
   LOOP
      ...
      normal_merge_trans_data (in_schedule_no,
                               fngset_list_iterator.systemid,
                               fngset_list_iterator.endstno,
