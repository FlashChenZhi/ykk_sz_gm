DROP PROCEDURE AWC.KEN;

CREATE OR REPLACE PROCEDURE AWC.KEN
		(
			IO_RC		IN OUT	NUMBER,
...
DEF_MYNAME		CONSTANT VARCHAR2(10)	:= 'KEN' ;
...
DBMS_OUTPUT.PUT_LINE(' ICHIJI NYUKO SYORI START ');
	...
	KEN_B0 (D_FNHANSO.SAGYOKBN, SYORIKBN_NYUKO, IO_RC, WK_LOGMSG) ;
...
DBMS_OUTPUT.PUT_LINE(' CHOKO SYORI START ');
	...
	IF WK_FIRSTFLG = 0 THEN
		...
		KEN_B0 (PA_AWC_DEFINE.SAGYOKBN_IKISAKISIJI, SYORIKBN_NYUKO, IO_RC, WK_LOGMSG) ;
		...
		KEN_I0 (D_FNHANSO.HANSOKEY, IO_RC, WK_LOGMSG) ;
		IF IO_RC != FUKKI.RET_OK THEN
			GOTO	KEN_80ENDLABEL ;
		END IF ;
...
DBMS_OUTPUT.PUT_LINE(' NYUKO SYORI START ');
	...
	KEN_B0 (WK_SAGYOKBN, SYORIKBN_NYUKO, IO_RC, WK_LOGMSG) ;
...
DBMS_OUTPUT.PUT_LINE(' KEIRYO HOUKOKU ZUMI ');
				...
				KEN_70 (D_FNHANSO.SAGYOKBN, IO_RC, WK_LOGMSG) ;
...
DBMS_OUTPUT.PUT_LINE(' NYUKO DATA FIRSTFLG[' || WK_FIRSTFLG || ']');
			...
			KEN_70 (PA_AWC_DEFINE.SAGYOKBN_IKISAKISIJI, IO_RC, WK_LOGMSG) ;
