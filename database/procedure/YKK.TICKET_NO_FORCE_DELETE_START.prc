DROP PROCEDURE YKK.TICKET_NO_FORCE_DELETE_START;

CREATE OR REPLACE PROCEDURE YKK.ticket_no_force_delete_start (
...
BEGIN
   ...
   LOOP
      ...
      DELETE      fnzaiko
            WHERE ticket_no = fngset_list_iterator.ticket_no;
   END LOOP;
