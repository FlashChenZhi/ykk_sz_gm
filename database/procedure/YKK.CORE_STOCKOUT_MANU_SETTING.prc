DROP PROCEDURE YKK.CORE_STOCKOUT_MANU_SETTING;

CREATE OR REPLACE PROCEDURE YKK.core_stockout_manu_setting (
...
BEGIN
   ...
   LOOP
      ...
      SELECT COUNT (*)
       ...
       WHERE zaikey = wk_fnzaiko_row.zaikey AND TRIM (color_code) IS NULL;
