DROP PROCEDURE YKK.PICKING_NORMAL_START;

CREATE OR REPLACE PROCEDURE YKK.picking_normal_start (
...
IS
   ...
   BEGIN
      ...
      THEN
         SELECT section, line, picking_num, retrieval_station
           INTO wk_section, wk_line, wk_picking_num, wk_retrieval_station
         ...
         UPDATE fnsiji
            SET mckey = in_new_mckey,
                hansokey = in_hansokey
          WHERE mckey = in_old_mckey
      ...
      ELSE
         SELECT customer_code, retrieval_station, order_no,
                picking_num
           INTO wk_customer_code, wk_retrieval_station, wk_order_no,
                wk_picking_num
