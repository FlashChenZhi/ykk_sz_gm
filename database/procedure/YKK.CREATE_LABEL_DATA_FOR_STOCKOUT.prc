DROP PROCEDURE YKK.CREATE_LABEL_DATA_FOR_STOCKOUT;

CREATE OR REPLACE PROCEDURE YKK.create_label_data_for_stockout (
...
BEGIN
   ...
   SELECT fnzaiko.ticket_no, fnzaiko.bucket_no,
          fnzaiko.zaikey, fnzaiko.color_code,
          fnsyotei.section, fnsyotei.line,
          fnzaiko.made_section, fnzaiko.made_line,
          fnsyotei.start_date, fnsyotei.start_timing_flag,
          fnzaiko.real_unit_weight, fnsyotei.depot_code,
          fnsyotei.customer_code, fnsyotei.customer_name1,
          fnsyotei.customer_name2, fnsyotei.pr_no,
          fnsyotei.retrieval_station, fnsyotei.order_no
     INTO wk_fnlabel_row.ticket_no, wk_fnlabel_row.bucket_no,
          wk_fnlabel_row.zaikey, wk_fnlabel_row.color_code,
          wk_fnlabel_row.section, wk_fnlabel_row.line,
          wk_fnlabel_row.made_section, wk_fnlabel_row.made_line,
          wk_fnlabel_row.start_date, wk_fnlabel_row.start_timing_flag,
          wk_fnlabel_row.master_unit_weight, wk_fnlabel_row.depot_code,
          wk_fnlabel_row.customer_code, wk_fnlabel_row.customer_name1,
          wk_fnlabel_row.customer_name2, wk_fnlabel_row.pr_no,
          wk_fnlabel_row.retrieval_station, wk_fnlabel_row.order_no
