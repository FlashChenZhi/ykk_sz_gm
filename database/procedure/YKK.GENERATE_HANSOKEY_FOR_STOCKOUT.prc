DROP PROCEDURE YKK.GENERATE_HANSOKEY_FOR_STOCKOUT;

CREATE OR REPLACE PROCEDURE YKK.generate_hansokey_for_stockout (
...
--   END IF;
   SELECT LPAD (TO_CHAR (seq_hansokey.NEXTVAL), 16, '0')
     INTO io_hansokey
     FROM DUAL;
EXCEPTION
   WHEN OTHERS
