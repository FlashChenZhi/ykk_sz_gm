<%-- $Id: IOHistoryInfoPopup.jsp,v 1.1 2007/12/13 06:25:11 administrator Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee><h:fixedlistcell id="lst_IOHistoryInfoPopupHead" templateKey="YKK_LST_IOHistoryInfoPopupHead"/></TD></TR></TBODY></TABLE></TD>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_IOHistoryInfoPopup" templateKey="YKK_LST_IOHistoryInfoPopup"/></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD></TR>
        <TR bgColor=#b8b7d7>
