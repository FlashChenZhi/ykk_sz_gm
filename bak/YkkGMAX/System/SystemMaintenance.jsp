<%-- $Id: SystemMaintenance.jsp,v 1.1 2007/12/13 06:25:12 administrator Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#413a8a 
        ...
        <TR>
          ...
          <TD><h:label id="lbl_SettingName" templateKey="YKK_LBL_SystemMaintenance"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_FIFODays" templateKey="YKK-LBL-FIFODays"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_FIFODays" templateKey="YKK_TXT_FIFODays"/><h:label id="lbl_Day" templateKey="YKK-LBL-Day"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
