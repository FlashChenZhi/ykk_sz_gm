...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#413a8a 
        ...
        <TR>
          ...
          <TD><h:label id="lbl_SettingName" templateKey="YKK_LBL_ExternalStockoutStart"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                  ...
                  <TABLE>
                    ...
                    <TR>
                      <TD><h:label id="lbl_Section" templateKey="YKK_LBL_Section"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_Section" templateKey="YKK_PUL_Section"/>&nbsp;&nbsp;&nbsp;<h:label id="lbl_RetrievalNo" templateKey="YKK_LBL_RetrievalNo"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_RetrievalNo" templateKey="YKK_TXT_RetrievalNo"/>&nbsp;&nbsp; 
                        <h:label id="lbl_OrderNo" templateKey="YKK_LBL_OrderNo"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_OrderNo" templateKey="YKK_TXT_OrderNo"/></TD>
                      ...
                      <TD>
                        <TABLE>
                          ...
                          <TR>
                            ...
                            <TD align=right 
                              width="100%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                              <h:submitbutton id="btn_SelectAllUnit" templateKey="YKK_BTN_SelectAllUnit"/>&nbsp;&nbsp; 
              ...
              <TR bgColor=#b8b7d7>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_ExternalStockoutStart" templateKey="YKK_LST_ExternalStockoutStart"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    <TBODY>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD align=right width="80%"><h:label id="lbl_DesignateStockoutStation" templateKey="YKK_LBL_DesignateStockoutStation"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:pulldown id="pul_DesignateStockoutStation" templateKey="YKK_PUL_DesignateStockoutStation"/>&nbsp;&nbsp; 
                        <h:radiobutton id="rdo_Auto" templateKey="YKK_RDO_Auto"/><h:radiobutton id="rdo_Picking" templateKey="YKK_RDO_Picking"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        <h:label id="lbl_SelectedUnitCount" templateKey="YKK_LBL_SelectedUnitCount"/><h:label id="lbl_EqualsMark" templateKey="YKK_LBL_EqualsMark"/><h:numbertextbox id="txt_SelectedUnitCount" templateKey="YKK_TXT_SelectedUnitCount_RO"/>&nbsp;&nbsp; <h:label id="lbl_TotalStockOutQty" templateKey="YKK_LBL_TotalStockOutQty"/><h:label id="lbl_EqualsMark_2" templateKey="YKK_LBL_EqualsMark"/><h:numbertextbox id="txt_TotalStockOutQty" templateKey="YKK_TXT_TotalStockOutQty"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
