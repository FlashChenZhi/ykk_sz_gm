// $Id: InstockReceiveQtyInquiry.java,v 1.1.1.1 2006/08/17 09:34:11 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class InstockReceiveQtyInquiry extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SInstkRcvQtyIqr = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SInstkRcvQtyIqr" , "W_S_InstockReceiveQtyInquiry");
