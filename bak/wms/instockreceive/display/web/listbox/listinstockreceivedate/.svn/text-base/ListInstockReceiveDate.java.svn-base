// $Id: ListInstockReceiveDate.java,v 1.1.1.1 2006/08/17 09:34:12 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListInstockReceiveDate extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_InstkAcceptDateSrch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_InstkAcceptDateSrch" , "W_InstkAcceptDateSrch");
