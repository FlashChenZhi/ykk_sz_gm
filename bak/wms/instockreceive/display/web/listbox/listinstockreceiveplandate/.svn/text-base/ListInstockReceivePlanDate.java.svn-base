// $Id: ListInstockReceivePlanDate.java,v 1.1.1.1 2006/08/17 09:34:12 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListInstockReceivePlanDate extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_InstkPlanDateSrch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_InstkPlanDateSrch" , "W_InstkPlanDateSrch");
