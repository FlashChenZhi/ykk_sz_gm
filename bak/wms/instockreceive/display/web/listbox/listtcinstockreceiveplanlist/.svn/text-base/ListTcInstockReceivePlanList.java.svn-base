// $Id: ListTcInstockReceivePlanList.java,v 1.1.1.1 2006/08/17 09:34:13 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListTcInstockReceivePlanList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_InstkTCPlanList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_InstkTCPlanList" , "W_InstkTCPlanList");
