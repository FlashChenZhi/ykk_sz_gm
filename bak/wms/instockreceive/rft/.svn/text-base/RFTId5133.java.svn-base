// $Id: RFTId5133.java,v 1.1.1.1 2006/08/17 09:34:14 mori Exp $
...
/**
 * 仕入先単位入荷検品(DC･クロス)実績応答 ID=5133 電文を処理します
 * 
 * <p>
 * <table border="1">
 * <CAPTION>Id5133の電文の構造</CAPTION>
 * <TR><TH>項目名</TH>			<TH>長さ</TH>	<TH>内容</TH></TR>
 * <tr><td>STX</td>				<td>1 byte</td>	<td>0x02</td></tr>
 * <tr><td>SEQ NO</td>			<td>4 byte</td>	<td>未使用</td></tr>
 * <tr><td>ID</td>				<td>4 byte</td>	<td>5133</td></tr>
 ...
 * @author  $Author: mori $
 */
public class RFTId5133 extends SendIdMessage
{
	// Class fields --------------------------------------------------
	/**
	 * 担当者コードのオフセットの定義
	 ...
	 * ID番号
	 */
	public static final String ID = "5133";
