// $Id: ListSortingSupplierBusiness.java,v 1.1.1.1 2006/08/17 09:34:32 mori Exp $
 ...
 */
package jp.co.daifuku.wms.sorting.display.web.listbox.listsortingsupplier;
...
import jp.co.daifuku.wms.sorting.display.web.listbox.sessionret.SessionSortingWorkInfoSupplierRet;
 ...
 * @author  $Author: mori $
 */
public class ListSortingSupplierBusiness extends ListSortingSupplier implements WMSConstants
{
	// Class fields --------------------------------------------------
	/** 
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		//SessionSortingSupplierRet インスタンス生成
		SessionSortingWorkInfoSupplierRet listbox = new SessionSortingWorkInfoSupplierRet(conn, param);
		//Sessionにlistboxを保持
	 ...
	 * @throws Exception 全ての例外を報告します。
	 */
	private void setWorkList(SessionSortingWorkInfoSupplierRet listbox, String actionName) throws Exception
	{
		// ページ情報をセット
		...
		if (len > 0)
		{
			...
			for (int i = 0; i < len; i++)
			{
				...
				lst_SupplierSearch.setValue(3, splan[i].getSupplierName());
			}
		}
		else
		{
	...
	public void pgr_D_Next(ActionEvent e) throws Exception
	{
		...
		// Sessionにlistboxを保持
		SessionSortingWorkInfoSupplierRet listbox =
			(SessionSortingWorkInfoSupplierRet) this.getSession().getAttribute("LISTBOX");
