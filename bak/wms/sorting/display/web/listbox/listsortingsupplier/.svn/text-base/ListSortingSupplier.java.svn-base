// $Id: ListSortingSupplier.java,v 1.1.1.1 2006/08/17 09:34:32 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListSortingSupplier extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SupplierSearch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SupplierSearch" , "W_SupplierSearch");
