// $Id: ListSortingPlanList.java,v 1.1.1.1 2006/08/17 09:34:31 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListSortingPlanList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_PickingPlanList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_PickingPlanList" , "W_PickingPlanList");
