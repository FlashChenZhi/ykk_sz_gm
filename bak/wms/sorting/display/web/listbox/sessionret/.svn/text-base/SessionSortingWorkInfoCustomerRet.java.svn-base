 ...
 * <BR>
 * 1.検索処理(<CODE>SessionSortingWorkInfoCustomerRet(Connection conn,SortingParameter param)</CODE>メソッド)<BR>
 * <DIR>
...
public class SessionSortingWorkInfoCustomerRet extends SessionRet
{
	// Class fields --------------------------------------------------
	 ...
	 */
	public SessionSortingWorkInfoCustomerRet(Connection conn, SortingParameter param) throws Exception
	{
		this.wConn = conn;
		find(param);
	}
