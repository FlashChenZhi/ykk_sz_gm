// $Id: RetrievalPlanMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $
...
public class RetrievalPlanMGWrapper
		extends MergerWrapper
{
	 ...
	 */
	public RetrievalPlanMGWrapper(Connection conn)
	...
	{
		if (ent instanceof RetrievalPlan)
		{
			RetrievalPlan aent = (RetrievalPlan)ent ;
	...
	{
		return "$Id: RetrievalPlanMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $" ;
	}
}
