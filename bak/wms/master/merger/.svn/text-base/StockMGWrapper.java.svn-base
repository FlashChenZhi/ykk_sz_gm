// $Id: StockMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $
		...
		extends MergerWrapper
{
	 ...
	 */
	public StockMGWrapper(Connection conn)
	...
	{
		if (ent instanceof Stock)
		{
			Stock aent = (Stock)ent ;
	...
	{
		return "$Id: StockMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $" ;
	}
}
