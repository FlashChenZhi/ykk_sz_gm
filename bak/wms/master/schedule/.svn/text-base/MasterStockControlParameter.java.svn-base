 ...
 * Maker : S.Yoshida <BR>
 * <BR>
 * <CODE>MasterStockControlParameter</CODE>クラスは、マスタパッケージ導入時の
 * 在庫パッケージ内の画面～スケジュール間のパラメータの受渡しに使用します。<BR>
 * <BR>
 * <DIR>
 * <CODE>MasterStockControlParameter</CODE>クラスが保持する項目<BR>
 * <BR>
 *     補完タイプ<BR>
 * <BR>
 * <BR>
 ...
 * @author  $Author: mori $
 */
public class MasterStockControlParameter extends jp.co.daifuku.wms.stockcontrol.schedule.StockControlParameter
{
	// Class feilds ------------------------------------------------
	/**
	 * 補完タイプ (すべて上書き)
	 ...
	 * このクラスの初期化を行ないます。
	 */
	public MasterStockControlParameter()
	{
	}
