// $Id: CorrectConsignorMaster2Business.java,v 1.1.1.1 2006/08/17 09:34:16 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class CorrectConsignorMaster2Business extends CorrectConsignorMaster2 implements WMSConstants
{
	// Class fields --------------------------------------------------
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		try
		{
			...
			// 画面に返却データを設定します。 
			// 荷主コード
			lbl_JavaSet.setText(initParam[0].getConsignorCode());
			// 荷主名称
			txt_consignorName.setText(initParam[0].getConsignorName());
			// 最終更新日
	...
	public void btn_modify_Click(ActionEvent e) throws Exception
	{
		...
		try
		{
			...
			// 荷主コード
			param[0].setConsignorCode(lbl_JavaSet.getText());
			// 荷主名称
	...
	{
		//画面遷移を行う
		forward("/master/correctconsignormaster/CorrectConsignorMaster.do");
	}
