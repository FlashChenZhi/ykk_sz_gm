// $Id: ListMasterItem.java,v 1.1.1.1 2006/08/17 09:34:16 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListMasterItem extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ItemSearch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ItemSearch" , "W_MasterItemSearch");
