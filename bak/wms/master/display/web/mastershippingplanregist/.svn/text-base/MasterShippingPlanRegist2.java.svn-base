...
// $Id: MasterShippingPlanRegist2.java,v 1.1.1.1 2006/08/17 09:34:18 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class MasterShippingPlanRegist2 extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SShpPlnDaRst = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SShpPlnDaRst" , "W_S_ShpPlnDaRst");
