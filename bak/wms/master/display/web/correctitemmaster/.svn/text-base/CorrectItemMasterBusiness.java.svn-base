// $Id: CorrectItemMasterBusiness.java,v 1.1.1.1 2006/08/17 09:34:16 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class CorrectItemMasterBusiness extends CorrectItemMaster implements WMSConstants
{
	// 遷移先アドレス
	// 荷主検索ポップアップアドレス
	...
	// 検索条件
	protected static final String searchKey = "3";
	// Class fields --------------------------------------------------
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		// 商品コードに入力値があるとき
		if (!StringUtil.isBlank(getViewState().getString("ItemCode")))
		{
			txt_itemCode.setText(getViewState().getString("ItemCode"));
		}
	...
	public void btn_next_Click(ActionEvent e) throws Exception
	{
		...
		try
		{
            ...
            if (schedule.nextCheck(conn,param))
            {
				...
				// ViewStateに商品コードをセットする
				getViewState().setString("ItemCode", txt_itemCode.getText());
				// ViewStateに画面タイトルをセットする
				getViewState().setString("TITLE", lbl_SettingName.getResourceKey());
                // 画面遷移を行う
				forward("/master/correctitemmaster/CorrectItemMaster2.do");
            }
            else
            {
	 ...
	 * @throws Exception 
	 */
	public void txt_workerCode_AutoCompleteItemClick(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_workerCode_AutoComplete(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_password_AutoCompleteItemClick(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_consignorCode_AutoCompleteItemClick(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_consignorCode_AutoComplete(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void btn_ConsignorSearch_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void btn_ItemSearch_Server(ActionEvent e) throws Exception
	{
	}
