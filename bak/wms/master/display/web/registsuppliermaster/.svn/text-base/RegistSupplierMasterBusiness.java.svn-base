// $Id: RegistSupplierMasterBusiness.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $
 ...
 */
package jp.co.daifuku.wms.master.display.web.registsuppliermaster;
...
import jp.co.daifuku.wms.master.schedule.RegistSupplierMasterSCH;
 ...
 * @author  $Author: mori $
 */
public class RegistSupplierMasterBusiness extends RegistSupplierMaster implements WMSConstants
{
	// 遷移先アドレス
	// 荷主検索ポップアップアドレス
	 ...
	 */
	 public void page_DlgBack(ActionEvent e) throws Exception
	 {
		...
		// 仕入先名称
		if (!StringUtil.isBlank(param.getParameter(ListMasterSupplierBusiness.SUPPLIERNAME_KEY)))
		{
			txt_supplierName.setText(param.getParameter(ListMasterSupplierBusiness.SUPPLIERNAME_KEY));
		}
		// カーソルを作業者コードに移動する
		setFocus(txt_workerCode);
	 }
	...
	private void setConsignor() throws Exception
	{
		...
		try
		{
			...
			// スケジュールから荷主コードを取得します
			WmsScheduler schedule = new RegistSupplierMasterSCH();
