// $Id: ListInventoryList.java,v 1.2 2006/12/07 08:57:45 suresh Exp $
 ...
 */
public class ListInventoryList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_StrgInvntryLst = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_StrgInvntryLst" , "W_StrgInvntryLst");
