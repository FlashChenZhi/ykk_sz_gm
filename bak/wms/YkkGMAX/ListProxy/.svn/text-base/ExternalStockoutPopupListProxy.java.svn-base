...
public class ExternalStockoutPopupListProxy
{
	public ExternalStockoutPopupListProxy(ListCell list, Page page)
	{
		this.list = list;
		this.page = page;
	}
	...
	public String getEXTERNAL_STOCKOUT_DETAIL_LIST()
	{
		return EXTERNAL_STOCKOUT_DETAIL_LIST;
	}
	...
	public void setTicketNo(String status)
	{
	...
	public ExternalStockoutDetailEntity getExternalStockoutDetailEntity()
	{
	...
	public void setRowValueByEntity(ExternalStockoutDetailEntity entity)
	{
		...
		if (SystemIdSortableHandler.contain((ArrayList) page.getSession()
				.getAttribute(EXTERNAL_STOCKOUT_DETAIL_LIST), entity
				.getSystemId()))
		{
			setAll(true);
		}
