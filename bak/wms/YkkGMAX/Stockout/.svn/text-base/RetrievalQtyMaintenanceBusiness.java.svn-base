...
import jp.co.daifuku.wms.YkkGMAX.PageController.RetrievalQtyMaintenancePager;
...
import jp.co.daifuku.wms.YkkGMAX.resident.RetrievalQtyMaintenanceRequestProcessor;
 ...
 */
public class RetrievalQtyMaintenanceBusiness extends RetrievalQtyMaintenance
		implements WMSConstants
{
	...
	private final PageController pageController = new PageController(
			new RetrievalQtyMaintenancePager(this, pgr_Up),
			new RetrievalQtyMaintenancePager(this, pgr_Low), message);

	private final RetrievalQtyMaintenanceListProxy listProxy = new RetrievalQtyMaintenanceListProxy(
			lst_RetrievalQtyMaintenance, this);
	...
	public void page_ConfirmBack(ActionEvent e) throws Exception
	{
		...
		if (this.getViewState().getBoolean(DIALOG_FLAG))
		{
			...
			ArrayList retrievalQtyMaintenanceList = (ArrayList) session
					.getAttribute(RETRIEVAL_QTY_MAINTENANCE_LIST);

			for (int i = 0; i < retrievalQtyMaintenanceList.size(); i++)
			{
				RetrievalQtyMaintenanceEntity entity = (RetrievalQtyMaintenanceEntity) retrievalQtyMaintenanceList
						.get(i);

				if (entity.getStockoutNecessaryQty() < entity
						.getManagementRetrievalQty()
						|| entity.getManagementRetrievalQty() < entity
								.getOutQty())
				{
					message.setMsgResourceKey("7000042");
			...
			if (retrievalQtyMaintenanceList != null
					&& retrievalQtyMaintenanceList.size() > 0)
			{
				pi.addProcessor(new RetrievalQtyMaintenanceRequestProcessor(
						retrievalQtyMaintenanceList));
			}
			pi.run();

			lst_RetrievalQtyMaintenance.clearRow();
	...
	private void InitPage()
	{
		...
		session.setAttribute(RETRIEVAL_QTY_MAINTENANCE_LIST, new ArrayList());
		txt_TotalOutQty.setText("");
		txt_TotalRetrievalQty.setText("");
		txt_RQMinusOQ.setText("");
	...
	public void btn_Show_Click(ActionEvent e) throws Exception
	{
		...
		entity.setRetrieved(chk_DisplayFinishedRetrieval.getChecked());
		...
		session.setAttribute(RETRIEVAL_QTY_MAINTENANCE_ENTITY, entity);
		...
		try
		{
			...
			String[] qty = centre.getRetrievalQtyMaintenanceRetrievalQtyAndOutQty(entity);

			if (qty[0].length() > 12)
			{
				txt_TotalRetrievalQty.setText("MAX");
			}
			else 
			{
				txt_TotalRetrievalQty.setLong(Long.parseLong(qty[0]));
			}
			...
			if(qty[2].length() > 12)
			{
				txt_RQMinusOQ.setText("MAX");
			}
			else
			{
				txt_RQMinusOQ.setLong(Long.parseLong(qty[2]));
			}
		}
		catch (YKKDBException dbEx)
		{
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_EnterKey(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_TabKey(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_InputComplete(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_ColumClick(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_Server(ActionEvent e)
			throws Exception
	{
		int row = Integer.parseInt(e.getEventArgs().get(0).toString());
		int col = Integer.parseInt(e.getEventArgs().get(1).toString());
		if (col == listProxy.getMANAGEMENT_RETRIEVAL_QTY_COLUMN())
		{
			ArrayList list = (ArrayList) session
					.getAttribute(RETRIEVAL_QTY_MAINTENANCE_LIST);
			lst_RetrievalQtyMaintenance.setCurrentRow(row);

			if (RetrievalPlankeySortableHandler.contain(list, listProxy
					.getRowValue().getRetrievalPlankey()))
			{
				((RetrievalQtyMaintenanceEntity) RetrievalPlankeySortableHandler
						.get(list, listProxy.getRowValue()
								.getRetrievalPlankey()))
						.setManagementRetrievalQty(listProxy
								.getManagementRetrievalQty());
			}
			else
			{
				RetrievalPlankeySortableHandler.insert(list, listProxy
						.getRowValue());
			}

			if (listProxy.getStockoutNecessaryQty() < listProxy
					.getManagementRetrievalQty()
					|| listProxy.getManagementRetrievalQty() < listProxy
							.getOutQty())
			{
				message.setMsgResourceKey("7000042");
				// listProxy.setManagementRetrievalQty(listProxy
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_Change(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception
	 */
	public void lst_RetrievalQtyMaintenance_Click(ActionEvent e)
			throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lbl_TotalRetrievalQty_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_TotalRetrievalQty_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_TotalRetrievalQty_EnterKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_TotalRetrievalQty_TabKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lbl_MinusMark_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_RQMinusOQ_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_RQMinusOQ_EnterKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_RQMinusOQ_TabKey(ActionEvent e) throws Exception
	{
	}
