 ...
 */
public class MessageInfoPopup extends Page
{

	// Class variables -----------------------------------------------
	public jp.co.daifuku.bluedog.ui.control.Message message = jp.co.daifuku.bluedog.ui.control.MessageFactory.getInstance("message" , "OperationMsg");
	public jp.co.daifuku.bluedog.ui.control.FixedListCell lst_MessageInfoPopupHead = jp.co.daifuku.bluedog.ui.control.FixedListCellFactory.getInstance("lst_MessageInfoPopupHead" , "YKK_LST_MessageInfoPopupHead");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_MessageInfoPopup = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_MessageInfoPopup" , "YKK_LST_MessageInfoPopup");
