// $Id: ListShippingDate.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListShippingDate extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ShpAcpDateSrch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ShpAcpDateSrch" , "W_ShpAcpDateSrch");
