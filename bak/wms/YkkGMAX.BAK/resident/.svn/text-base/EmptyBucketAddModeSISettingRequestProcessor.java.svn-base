...
public class EmptyBucketAddModeSISettingRequestProcessor extends BasicProcessor
{
    private String mode = "";

    public EmptyBucketAddModeSISettingRequestProcessor(String mode)
    {
	this.mode = mode;
    }
