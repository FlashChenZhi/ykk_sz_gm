...
public class NormalRsvDataDeleteProcessor extends BasicProcessor
{

	private String ip;
	private List dataList;

	public NormalRsvDataDeleteProcessor(String ip, List dataList)
	{
		this.ip = ip;
			...
			throws YKKDBException, YKKSQLException
	{
		...
		{
			StockoutEntity entity = (StockoutEntity) dataList.get(i);
