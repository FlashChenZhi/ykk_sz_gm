// $Id: ListIdmBundleItfBusiness.java,v 1.1.1.1 2006/08/17 09:34:09 mori Exp $
 ...
 */
package jp.co.daifuku.wms.idm.display.web.listbox.listidmbundleitf;
...
import jp.co.daifuku.wms.idm.display.web.listbox.sessionret.SessionIdmBundleItfRet;
 ...
 * 開始棚、終了棚、ケースＩＴＦ、ボールＩＴＦを基に検索します。<BR>
 * <BR>
 * 1.初期画面（<CODE>page_Load(ActionEvent e)</CODE>メソッド）<BR>
 * <BR>
 * <DIR>
 *  親画面から入力した荷主コード、商品コード、開始棚、終了棚、ケース・ピース区分、ケースＩＴＦ、ボールＩＴＦを基に検索します。<BR>
 * <BR>
 * </DIR>
 * 2.選択した行のボタン（<CODE>lst_StockBundleItf_Click</CODE>メソッド）<BR>
 * <BR>
 * <DIR>
 * 	選択行のボールITFを親画面に渡し、リストボックスを閉じます。<BR>
 * </FONT>
 * <BR>
 * <TABLE BORDER="1" CELLPADDING="3" CELLSPACING="0">
 * <TR BGCOLOR="#CCCCFF" CLASS="TableHeadingColor"><TD>Date</TD><TD>Name</TD><TD>Comment</TD></TR>
 * <TR><TD>2005/04/07</TD><TD>K.Toda</TD><TD>新規作成</TD></TR>
 * </TABLE>
 * <BR>
 * @version $Revision: 1.1.1.1 $, $Date: 2006/08/17 09:34:09 $
 * @author  $Author: mori $
 */
public class ListIdmBundleItfBusiness extends ListIdmBundleItf implements WMSConstants
{
	// Class fields --------------------------------------------------
	/** 
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		// ケースITF
		String caseitf = request.getParameter(ListIdmCaseItfBusiness.CASEITF_KEY);
		// ボールITF
		...
		// ケースITF
		lbl_JavaSetCaseItf.setText(caseitf);
		// 検索条件に荷主名称をセット
		...
		// SessionRet インスタンス生成
		SessionIdmBundleItfRet listbox = new SessionIdmBundleItfRet(conn, param);
		// Sessionにlistboxを保持
	 ...
	 * @param actionName
	 */
	private void setList(SessionIdmBundleItfRet listbox, String actionName)
	{
		// ページ情報をセット
	...
	{
		// Sessionにlistboxを保持
		SessionIdmBundleItfRet listbox = (SessionIdmBundleItfRet) this.getSession().getAttribute("LISTBOX");
