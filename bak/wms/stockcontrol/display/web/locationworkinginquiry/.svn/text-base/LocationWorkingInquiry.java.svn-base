// $Id: LocationWorkingInquiry.java,v 1.2 2006/10/04 05:04:20 suresh Exp $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/10/04 05:04:20 $
 * @author  $Author: suresh $
 */
public class LocationWorkingInquiry extends Page
{
