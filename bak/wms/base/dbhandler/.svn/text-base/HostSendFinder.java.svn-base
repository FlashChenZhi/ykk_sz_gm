//$Id: HostSendFinder.java,v 1.2 2006/11/09 07:53:04 suresh Exp $
...
/**
 * This class searches Hostsend in the database and maps with TestView
 ...
 */
public class HostSendFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public HostSendFinder(Connection conn)
	{
