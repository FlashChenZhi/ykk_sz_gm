//$Id: PaletteHandler.java,v 1.2 2006/11/09 07:51:42 suresh Exp $
		...
		extends AbstractDBHandler
{
	 ...
	 */
	public PaletteHandler(Connection conn)
	{
	...
	{
		return "$Id: PaletteHandler.java,v 1.2 2006/11/09 07:51:42 suresh Exp $" ;
	}
