//$Id: WareHouseFinder.java,v 1.2 2006/11/09 07:50:24 suresh Exp $
...
/**
 * This class searches Warehouse in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:24 $
 * @author  $Author: suresh $
 */
public class WareHouseFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WareHouseFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:24 $") ;
	}
