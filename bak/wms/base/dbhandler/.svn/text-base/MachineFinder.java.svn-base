//$Id: MachineFinder.java,v 1.2 2006/11/09 07:51:50 suresh Exp $
...
/**
 * This class searches Machine in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:50 $
 * @author  $Author: suresh $
 */
public class MachineFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:50 $") ;
	}
