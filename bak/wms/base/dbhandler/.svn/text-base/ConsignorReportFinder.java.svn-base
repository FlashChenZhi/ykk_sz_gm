//$Id: ConsignorReportFinder.java,v 1.2 2006/11/09 07:53:12 suresh Exp $
...
/**
 * This class searches the Consignor in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:12 $
 * @author  $Author: suresh $
 */
public class ConsignorReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ConsignorReportFinder(Connection conn)
	{
		super(conn, Consignor.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:12 $") ;
	}
