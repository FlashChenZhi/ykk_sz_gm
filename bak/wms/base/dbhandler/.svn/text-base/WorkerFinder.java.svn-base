//$Id: WorkerFinder.java,v 1.2 2006/11/09 07:50:20 suresh Exp $
...
/**
 * This class searches Worker in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:20 $
 * @author  $Author: suresh $
 */
public class WorkerFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WorkerFinder(Connection conn)
	{
		super(conn, Worker.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:20 $") ;
	}
