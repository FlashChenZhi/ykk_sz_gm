//$Id: MovementFinder.java,v 1.2 2006/11/09 07:51:48 suresh Exp $
...
/**
 * This class searches Movement in the database and maps with TestView
 ...
 */
public class MovementFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public MovementFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:48 $") ;
	}
