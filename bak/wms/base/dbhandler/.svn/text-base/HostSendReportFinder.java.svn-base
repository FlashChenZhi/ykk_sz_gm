//$Id: HostSendReportFinder.java,v 1.2 2006/11/09 07:53:04 suresh Exp $
...
/**
 * This class searches the Hostsend in the database and map it with TestView
 ...
 */
public class HostSendReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public HostSendReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:04 $") ;
	}
