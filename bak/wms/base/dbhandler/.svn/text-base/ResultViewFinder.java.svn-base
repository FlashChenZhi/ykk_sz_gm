//$Id: ResultViewFinder.java,v 1.2 2006/11/09 07:51:36 suresh Exp $
...
/**
 * This class searches Dvresultview in the database and maps with TestView
 ...
 */
public class ResultViewFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ResultViewFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:36 $") ;
	}
