//$Id: SortingPlanFinder.java,v 1.2 2006/11/09 07:50:39 suresh Exp $
...
/**
 * This class searches Sortingplan in the database and maps with TestView
 ...
 */
public class SortingPlanFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public SortingPlanFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:39 $") ;
	}
