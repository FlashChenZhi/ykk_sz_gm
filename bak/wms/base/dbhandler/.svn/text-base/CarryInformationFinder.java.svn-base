//$Id: CarryInformationFinder.java,v 1.2 2006/11/09 07:53:14 suresh Exp $
...
/**
 * This class searches Carryinfo in the database and maps with TestView
 ...
 */
public class CarryInformationFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public CarryInformationFinder(Connection conn)
	{
