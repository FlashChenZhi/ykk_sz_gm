//$Id: LocateFinder.java,v 1.2 2006/11/09 07:52:52 suresh Exp $
...
/**
 * This class searches Locate in the database and maps with TestView
 ...
 */
public class LocateFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public LocateFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:52:52 $") ;
	}
