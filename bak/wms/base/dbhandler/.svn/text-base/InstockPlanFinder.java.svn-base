//$Id: InstockPlanFinder.java,v 1.2 2006/11/09 07:52:58 suresh Exp $
...
/**
 * This class searches Instockplan in the database and maps with TestView
 ...
 */
public class InstockPlanFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public InstockPlanFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:52:58 $") ;
	}
