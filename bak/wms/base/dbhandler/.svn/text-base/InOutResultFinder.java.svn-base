//$Id: InOutResultFinder.java,v 1.2 2006/11/09 07:53:00 suresh Exp $
...
/**
 * This class searches Inoutresult in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:00 $
 * @author  $Author: suresh $
 */
public class InOutResultFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public InOutResultFinder(Connection conn)
	{
		super(conn, InOutResult.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:00 $") ;
	}
