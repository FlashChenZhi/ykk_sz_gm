//$Id: StationTypeHandler.java,v 1.2 2006/11/09 07:50:34 suresh Exp $
...
/**
 * Database handler for STATIONTYPE
 *
...
public class StationTypeHandler
		extends AbstractDBHandler
{
	 ...
	 */
	public StationTypeHandler(Connection conn)
	{
	...
	{
		return "$Id: StationTypeHandler.java,v 1.2 2006/11/09 07:50:34 suresh Exp $" ;
	}
