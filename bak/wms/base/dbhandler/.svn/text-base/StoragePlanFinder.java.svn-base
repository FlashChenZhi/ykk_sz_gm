//$Id: StoragePlanFinder.java,v 1.2 2006/11/09 07:50:30 suresh Exp $
...
/**
 * This class searches Storageplan in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:30 $
 * @author  $Author: suresh $
 */
public class StoragePlanFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public StoragePlanFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:30 $") ;
	}
