//$Id: BankSelectReportFinder.java,v 1.2 2006/11/09 07:53:16 suresh Exp $
...
/**
 * This class searches the Bankselect in the database and map it with TestView
 ...
 */
public class BankSelectReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public BankSelectReportFinder(Connection conn)
	{
