//$Id: TerminalAreaFinder.java,v 1.2 2006/11/09 07:50:26 suresh Exp $
...
/**
 * This class searches Terminalarea in the database and maps with TestView
 ...
 */
public class TerminalAreaFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public TerminalAreaFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:26 $") ;
	}
