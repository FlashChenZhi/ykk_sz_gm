//$Id: ResultReportFinder.java,v 1.2 2006/11/09 07:51:37 suresh Exp $
...
/**
 * This class searches the Result in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:37 $
 * @author  $Author: suresh $
 */
public class ResultReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ResultReportFinder(Connection conn)
	{
		super(conn, Result.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:37 $") ;
	}
