//$Id: ZoneViewFinder.java,v 1.3 2006/11/09 07:50:10 suresh Exp $
...
/**
 * This class searches Dvzoneview in the database and maps with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.3 $, $Date: 2006/11/09 07:50:10 $
 * @author  $Author: suresh $
 */
public class ZoneViewFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ZoneViewFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.3 $,$Date: 2006/11/09 07:50:10 $") ;
	}
