// $Id: Station.java,v 1.2 2006/10/30 05:14:52 suresh Exp $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/10/30 05:14:52 $
...
public class Station extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_MaxPaletteAQuantity = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_MaxPaletteAQuantity" , "AST_MaxPaletteAQuantity");
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_MaxPaletteQuantity = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_MaxPaletteQuantity" , "AST_MaxPaletteQuantity");
