...
<xsl:template match="/template">
  ...
  <xsl:variable name = "viewHeaderCount" >
    <xsl:value-of select="count(list-items[@type='ListCellColumns']/list-item[@type='ListCellColumn']/property[@name='header'][@value='true'])" />
  </xsl:variable>
            ...
            <xsl:for-each select="list-items[@type='ListCellColumns']/list-item[@type='ListCellColumn']">
              ...
              <xsl:if test="property[@name='header']/@value='true'">
                ...
                <td>
                  ...
                  <!-- set attribute "css" -->
                  <xsl:if test="property[@name='class']/@value!=''">
