// $Id: RoleMap.java,v 1.1.1.1 2006/08/17 09:33:11 mori Exp $
...
public class RoleMap extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_RoleMapInfoMsg = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_RoleMapInfoMsg" , "T_RoleMapInfoMsg");
	public jp.co.daifuku.bluedog.ui.control.CheckBox chk_All = jp.co.daifuku.bluedog.ui.control.CheckBoxFactory.getInstance("chk_All" , "T_All");
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_RoleMap = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_RoleMap" , "T_RoleMap");
