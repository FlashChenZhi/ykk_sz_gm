<%-- $Id: User.jsp,v 1.1.1.1 2006/08/17 09:33:07 mori Exp $ --%>
 ...
 * 
 * @version $Revision: 1.1.1.1 $, $Date: 2006/08/17 09:33:07 $
 * @author  $Author: mori $
--%>
<%--@@SYSTEM_TODO_START@@--%>
...
<h:head>
  ...
  <script>
	function dynamicAction()
	{
		...
		{
			if(!_isValueInput('txt_R_UserId')) 
			{
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6403021") %>',2);
				return true;
			}
		}
	}
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_UserId" templateKey="T_UserId"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:freetextbox id="txt_UserId" templateKey="T_UserId"/>&nbsp;<h:submitbutton id="btn_P_Search" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#dad9ee>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Password" templateKey="T_Password"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_PwdChangeInterval" templateKey="T_PwdChangeInterval"/>&nbsp;<h:checkbox id="chk_PwdChangeInterval" templateKey="T_PwdChangeInterval"/></TD></TR>
              <TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RoleId" templateKey="T_RoleId"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_RoleId" templateKey="T_RoleId"/>&nbsp;<h:submitbutton id="btn_P_Search2" templateKey="P_Search"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SameUserLoginMax" templateKey="T_SameUserLoginMax"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_SameUserLoginMax" templateKey="T_SameUserLoginMax"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_FailedLoginAttempts" templateKey="T_FailedLoginAttempts"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_FailedLoginAttempts" templateKey="T_FailedLoginAttempts"/></TD></TR>
              <TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_BirthDate" templateKey="T_BirthDate"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_BirthDate" templateKey="T_BirthDate"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Sex" templateKey="T_Sex"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_Sex" templateKey="T_Sex"/></TD></TR>
              <TR>
