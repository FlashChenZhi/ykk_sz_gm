<%-- $Id: FunctionMap2.jsp,v 1.1.1.1 2006/08/17 09:33:06 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD><h:submitbutton id="btn_Back" templateKey="Back"/>&nbsp;<h:submitbutton id="btn_ToMenu" templateKey="To_Menu"/></TD></TR></TBODY></TABLE>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR height=5>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ButtonResouceKey" templateKey="T_ButtonResourceKey"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ButtonResourceKey" templateKey="T_ButtonResourceKey"/>&nbsp;<h:submitbutton id="btn_P_ButtonResouceKey" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PageNameResouceKey" templateKey="T_PageNameResourceKey"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_PageNameResouceKey" templateKey="T_PageNameResouceKey"/>&nbsp;<h:submitbutton id="btn_P_PageResouceKey" templateKey="P_Search"/></TD></TR>
              <TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_URI" templateKey="T_URI"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_URI" templateKey="T_URI"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_FrameName" templateKey="T_FrameName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_FrameName" templateKey="T_FrameName"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
