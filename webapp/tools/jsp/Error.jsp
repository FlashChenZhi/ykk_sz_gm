<%-- $Id: Error.jsp,v 1.1.1.1 2006/08/17 09:33:06 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD  height=5 width=100% background="<%=request.getContextPath()%>/img/project/login/menu_bg.gif "></TD>
    <TD bgColor=#413a8a></TD>
  ...
  <TR>
    ...
    <TD bgColor=#413a8a></TD>
    <TD align=middle width=100% background="<%=request.getContextPath()%>/img/project/login/menu_bg.gif " height=251>
