<%-- $Id: WorkMaintenancePopup.jsp,v 1.1 2007/12/13 06:25:11 administrator Exp $ --%>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee><h:fixedlistcell id="lst_WorkMaintenancePopupHead" templateKey="YKK_LST_WorkMaintenancePopupHead"/></TD></TR></TBODY></TABLE></TD>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE>
              ...
              <TR>
                ...
                <TD><h:submitbutton id="btn_Print" templateKey="YKK_BTN_Print"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_CSV" templateKey="YKK_BTN_CSV"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_Up" templateKey="YKK_BTN_Close"/></TD></TR></TBODY></TABLE></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_WorkMaintenancePopup" templateKey="YKK_LST_WorkMaintenancePopup"/></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD></TR>
        <TR bgColor=#b8b7d7>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE>
              ...
              <TR>
                ...
                <TD><h:submitbutton id="btn_Reshow" templateKey="YKK_BTN_Reshow"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Close_Low" templateKey="YKK_BTN_Close"/></TD></TR></TBODY></TABLE></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
