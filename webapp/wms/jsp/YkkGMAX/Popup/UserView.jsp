...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_UserID" templateKey="YKK_TXT_UserID"/>&nbsp;&nbsp; <h:label id="lbl_LooseSearch" templateKey="YKK_LBL_LooseSearch"/><h:radiobutton id="rdo_SameToFront" templateKey="YKK_RDO_SameToFrontChecked"/><h:radiobutton id="rdo_SameToAnywhere" templateKey="YKK_RDO_SameToAnywhere"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_UserView" templateKey="YKK_LST_UserView"/></TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD></TR>
        <TR bgColor=#b8b7d7>
