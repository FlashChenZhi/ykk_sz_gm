<%-- $Id: ShippingPlanList.jsp,v 1.1.1.1 2006/08/17 09:33:23 mori Exp $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_PDisplay")
		{
			...
			if (_isValueInput('txt_StrtShpPlanDate') && _isValueInput('txt_EdShpPlanDate'))
			{
				if (!_isCorrectRange(document.all('txt_StrtShpPlanDate').value, document.all('txt_EdShpPlanDate').value))
				{
					document.all('txt_StrtShpPlanDate').focus();
					// 6023045=開始出荷予定日は、終了出荷予定日より前の日付にしてください。
					_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023045") %>',2);
					return true;
				}
			}
		}
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StrtShpPlanDate" templateKey="W_StrtShpPlanDate"/><h:submitbutton id="btn_PSearchStrtPlan" templateKey="P_Search"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:label id="lbl_EdShpPlanDate" templateKey="W_EdShpPlanDate"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:datetextbox id="txt_EdShpPlanDate" templateKey="W_EdShpPlanDate"/><h:submitbutton id="btn_PSearchEdPlan" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatusShipping" templateKey="W_WorkStatusShipping"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
