<%-- $Id: InventoryInquiry.jsp,v 1.1.1.1 2006/08/17 09:33:25 mori Exp $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Status" templateKey="W_Status"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_Sts_All" templateKey="W_Sts_All"/>&nbsp;&nbsp;&nbsp;&nbsp; 
                  &nbsp;<h:radiobutton id="rdo_Sts_StockDiff" templateKey="W_Sts_StockDiff"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Sts_StockEqualQty" templateKey="W_Sts_StockEqualQty"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
