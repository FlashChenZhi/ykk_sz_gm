<%-- $Id: StorageWorkMaintenance.jsp,v 1.1.1.1 2006/08/17 09:33:27 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StoragePlanDate" templateKey="W_StoragePlanDate"/><h:submitbutton id="btn_PSearchStrgPlanDate" templateKey="P_Search"/></TD></TR>
              <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_ModifySubmit" templateKey="W_ModifySubmit"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_AllWorkingClear" templateKey="W_AllWorkingClear"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_ListClear" templateKey="W_ListClear"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      <TD><h:label id="lbl_SStoragePlanDate" templateKey="W_StoragePlanDate"/></TD>
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:datetextbox id="txt_SRStoragePlanDate" templateKey="W_R_StoragePlanDate"/></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SStorageWorkMtn" templateKey="W_S_StorageWorkMtn"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
