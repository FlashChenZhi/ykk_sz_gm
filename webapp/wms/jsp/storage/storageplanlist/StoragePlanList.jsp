<%-- $Id: StoragePlanList.jsp,v 1.1.1.1 2006/08/17 09:33:26 mori Exp $ --%>
...
<h:head>
  <script>
	function dynamicAction()
	{
		...
		if (_isValueInput('txt_StrtStrgPlanDate') && _isValueInput('txt_EdStrgPlanDate'))
		{
			if (!_isCorrectRange(document.all('txt_StrtStrgPlanDate').value, document.all('txt_EdStrgPlanDate').value))
			{
				document.all('txt_StrtStrgPlanDate').focus();
				// 6023199=開始入庫予定日は、終了入庫予定日より前の日付にしてください。
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023199") %>',2);
				return true;
			}
		}
		return false;
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StrtStrgPlanDate" templateKey="W_StrtStrgPlanDate"/><h:submitbutton id="btn_PSearchStrtPlan" templateKey="P_Search"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:label id="lbl_EndStoragePlanDate" templateKey="W_EndStoragePlanDate"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:datetextbox id="txt_EdStrgPlanDate" templateKey="W_EdStrgPlanDate"/><h:submitbutton id="btn_PSearchEdPlan" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatusStorage" templateKey="W_WorkStatusStorage"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_PDisplay" templateKey="W_P_Display"/>&nbsp;&nbsp; 
