<%-- $Id: InventoryComplete.jsp,v 1.1.1.1 2006/08/17 09:33:25 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_StartLocation" templateKey="W_StartLocation"/><h:submitbutton id="btn_PSearchStrtLct" templateKey="P_Search"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:label id="lbl_EndLocation" templateKey="W_EndLocation"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_EndLocation" templateKey="W_EndLocation"/><h:submitbutton id="btn_PSearchEdLct" templateKey="P_Search"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_InventoryResult" templateKey="W_InventoryResult"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_AllCheck" templateKey="W_AllCheck"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_AllCheckClear" templateKey="W_AllCheckClear"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_ListClear" templateKey="W_ListClear"/> 
          </TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SInventoryComplete" templateKey="W_InventoryComplete"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
