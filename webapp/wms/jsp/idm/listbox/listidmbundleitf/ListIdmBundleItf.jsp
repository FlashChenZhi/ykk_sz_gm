<%-- $Id: ListIdmBundleItf.jsp,v 1.1.1.1 2006/08/17 09:33:17 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_1" templateKey="W_SearchCondition"/></TD>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetConsignorCode" templateKey="W_JavaSet"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:label id="lbl_JavaSetConsignorName" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_Item" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetItemCode" templateKey="W_JavaSet"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:label id="lbl_JavaSetItemName" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_Flag" templateKey="W_Flag"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetFlag" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_Location" templateKey="W_LocationRange"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetFromLocation" templateKey="W_JavaSet"/>&nbsp;&nbsp; <h:label id="lbl_12" templateKey="W_FromTo"/>&nbsp;&nbsp; <h:label id="lbl_JavaSetToLocation" templateKey="W_JavaSet"/></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_CaseItf" templateKey="W_CaseItf"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetCaseItf" templateKey="W_JavaSet"/></TD></TR></TBODY></TABLE></TD>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_ListStockBundleItf" templateKey="W_ListStockBundleItf"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
                ...
                <TD align=right height=10>
                  <TABLE cellSpacing=0 cellPadding=0 bgColor=#b8b7d7 border=0>
                    ...
                    <TR>
                      ...
                      <TD></TD>
                      <TD width=7 height=7><IMG height=1 src="img/common/spacer.gif" width=7 border=0></TD></TR></TBODY></TABLE></TD>
                <TD width=7 height=10><IMG height=1 src="img/common/spacer.gif" width=7 border=0></TD></TR></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
