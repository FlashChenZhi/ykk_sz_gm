<%-- $Id: RetrievalOrderList.jsp,v 1.1.1.1 2006/08/17 09:33:22 mori Exp $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_PDisplay")
		{
			...
			else if (!_isValueInput('txt_RtrivlPlanDate'))
			{
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatusRetrieval" templateKey="W_WorkStatusRetrieval"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
