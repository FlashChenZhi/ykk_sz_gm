<%-- $Id: RetrievalOrderComplete.jsp,v 1.1.1.1 2006/08/17 09:33:21 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_EndSet" templateKey="W_ListWorkEnd"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:datetextbox id="txt_RtrivlPlanDate" templateKey="W_RtrivlPlanDate"/><h:submitbutton id="btn_PSearchRtrivlPlanDate" templateKey="P_Search"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_OrderNo" templateKey="W_OrderNo"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_OrderNo" templateKey="W_OrderNo"/><h:submitbutton id="btn_PSearchOrderNo" templateKey="P_Search"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:radiobutton id="rdo_CpfAll" templateKey="W_Cpf_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                ...
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RtrvlFirstInput" templateKey="W_RtrvlFirstInput"/></TD>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_RetrievalConplete" templateKey="W_RetrievalComplete"/>&nbsp;&nbsp; 
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:datetextbox id="txt_RRtrivlPlanDate" templateKey="W_R_RtrivlPlanDate"/></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD><h:label id="lbl_OrderNoT" templateKey="W_OrderNo"/></TD>
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:freetextbox id="txt_ROrderNo" templateKey="W_R_OrderNo"/></TD>
                      <TD></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RetrievalOrderComplete" templateKey="W_RetrievalOrderComplete"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
