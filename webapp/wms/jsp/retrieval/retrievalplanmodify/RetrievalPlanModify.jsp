<%-- $Id: RetrievalPlanModify.jsp,v 1.1.1.1 2006/08/17 09:33:22 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:datetextbox id="txt_RtrivlPlanDate" templateKey="W_RtrivlPlanDate"/><h:submitbutton id="btn_PSearchRetrievalPlanDate" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_CaseRtrivlLct" templateKey="W_CaseRtrivlLct"/><h:submitbutton id="btn_PSearchCaseRtrivlLct" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_PiceRtrivlLct" templateKey="W_PiceRtrivlLct"/> </TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_PieceRtrivlLct" templateKey="W_PieceRtrivlLct"/><h:submitbutton id="btn_PSearchPiceRtrivlLct" templateKey="P_Search"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                </TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_CaseOrderNo" templateKey="W_CaseOrderNo"/><h:submitbutton id="btn_PSearchCaseOrder" templateKey="P_Search"/> 
                </TD>
