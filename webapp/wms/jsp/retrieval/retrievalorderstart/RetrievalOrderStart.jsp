<%-- $Id: RetrievalOrderStart.jsp,v 1.1.1.1 2006/08/17 09:33:22 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_StartSet" templateKey="W_ListWorkStart"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD noWrap bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_RtrivlPlanDate" templateKey="W_RtrivlPlanDate"/><h:submitbutton id="btn_PSearchRtrivlPlanDate" templateKey="P_Search"/></TD></TR>
              <TR>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_OrderPikingList" templateKey="W_OrderPikingList"/></TD>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_RetrivalStart" templateKey="W_RetrievalStart"/>&nbsp;&nbsp; 
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      <TD><h:label id="lbl_RetrivalPlanDateT" templateKey="W_RetrievalPlanDate"/></TD>
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_RetrivalOrderStart" templateKey="W_RetrievalOrderStart"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
