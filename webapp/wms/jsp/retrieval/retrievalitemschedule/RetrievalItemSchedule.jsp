<%-- $Id: RetrievalItemSchedule.jsp,v 1.1.1.1 2006/08/17 09:33:21 mori Exp $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD noWrap bgColor=#dad9ee colSpan=9></TD></TR>
              <TR bgColor=#dad9ee>
                ...
                <TD bgColor=#dad9ee colSpan=7><h:freetextbox id="txt_WorkerCode" templateKey="W_WorkerCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7 colSpan=5></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_StartItemCode" templateKey="W_StartItemCode"/></TD>
                <TD bgColor=#b8b7d7><h:submitbutton id="btn_PS_StartItemCode" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_FromTo" templateKey="W_FromTo"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_EndItemCode" templateKey="W_EndItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_EndItemCode" templateKey="W_EndItemCode"/></TD>
                <TD width="100%" bgColor=#b8b7d7><h:submitbutton id="btn_PS_EndItemCode" templateKey="P_Search"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=7><h:radiobutton id="rdo_CpfAll" templateKey="W_Cpf_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CpfCase" templateKey="W_Cpf_Case"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CpfPiece" templateKey="W_Cpf_Piece"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CpfAppointOff" templateKey="W_Cpf_AppointOff"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7><h:listcell id="lst_RetrievalItemSchedule" templateKey="W_RetrievalItemSchedule"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
