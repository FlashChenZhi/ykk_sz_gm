<%-- $Id: LoginSuccess.jsp,v 1.1.1.1 2006/08/17 09:33:19 mori Exp $ --%>
          ...
          <TD bgColor=#413a8a>
            <TABLE cellSpacing=0 cellPadding=0 bgColor=white border=0>
              ...
              <TR>
                ...
                <TD noWrap align=middle colSpan=3><h:label id="lbl_Msg01" templateKey="W_In_LoginInfoMsg1"/><BR><h:label id="lbl_Msg02" templateKey="W_LoginInfoMsg2"/></TD>
