<%-- $Id: RFTState.jsp,v 1.1.1.1 2006/08/17 09:33:28 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SRftWorkStatus" templateKey="W_S_RftWorkStatus"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" 
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_View" templateKey="Reflesh"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
