<%-- $Id: DefineReportDataStorage.jsp,v 1.1.1.1 2006/08/17 09:33:27 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_RptClmSetStrg" templateKey="W_RptClm_SetStrg"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_StrgPlanDate" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_StrgPlanDateLen" templateKey="W_StrgPlanDateLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenStrgPlanDate" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_StrgPlanDatePst" templateKey="W_StrgPlanDatePst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD align=middle bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_StrgQtyPtl" templateKey="W_StrgQtyPtl"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_StrgQtyPtl" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_StrgQtyPtlLen" templateKey="W_StrgQtyPtlLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenStrgQtyPtl" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_StrgQtyPtlPst" templateKey="W_StrgQtyPtlPst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
