<%-- $Id: DefineReportDataInstock.jsp,v 1.1.1.1 2006/08/17 09:33:27 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_RptClmSetInstk" templateKey="W_RptClm_SetInstk"/></TD>
          <TD width="90%" height=28></TD>
          <TD><h:submitbutton id="btn_Back" templateKey="Back"/>&nbsp;&nbsp;</TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_InstkPlanDate" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkPlanDateLen" templateKey="W_InstkPlanDateLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenInstkPlanDate" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkPlanDatePst" templateKey="W_InstkPlanDatePst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
              ...
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_OrderingDate" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_OrderingDateLen" templateKey="W_OdrgDateLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenOrderingDate" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_OrderingDatePst" templateKey="W_OdrgDatePst"/></TD>
                <TD 
                  bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                </TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_InstkPlanQtyPtl" templateKey="W_InstkPlanQtyPtl"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_InstkPlanQtyPtl" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkPlanQtyPtlLen" templateKey="W_InstkPlanQtyPtlLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenInstkPlanQtyPtl" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkPlanQtyPtlPst" templateKey="W_InstkPlanQtyPtlPst"/></TD></TR>
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_TCDCfFlg" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_TCDCfFlgLen" templateKey="W_TCDCFlagLength"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenTCDCfFlg" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_TCDCFlgPst" templateKey="W_TCDCFlagPosition"/></TD></TR>
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                ...
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_CustCdPst" templateKey="W_CustCdPst"/></TD></TR>
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_SupplierCdPst" templateKey="W_SplCdPst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                ...
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_CustNmPst" templateKey="W_CustNmPst"/></TD></TR>
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_InstkQtyPtl" templateKey="W_InstkQtyPtl"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_InstkQtyPtl" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkQtyPtlLen" templateKey="W_InstkQtyPtlLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenInstkQtyPtl" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkQtyPtlPst" templateKey="W_InstkQtyPtlPst"/></TD></TR>
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_InstockResultDate" templateKey="W_InstockResultDate"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_InstkRsltDate" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkRsltDateLen" templateKey="W_InstkRsltDateLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenInstkRsltDate" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_InstkRsltDatePst" templateKey="W_InstkRsltDatePst"/></TD></TR>
              <TR>
