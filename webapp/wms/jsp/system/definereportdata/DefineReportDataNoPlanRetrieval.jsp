<%-- $Id: DefineReportDataNoPlanRetrieval.jsp,v 1.1.1.1 2006/08/17 09:33:27 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_RptClmSetNoPlanRtrivl" templateKey="W_RptClm_SetNoPlanRtrivl"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PiceRtrivlLct" templateKey="W_PiceRtrivlLct"/></TD>
                ...
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_PieceRtrivlLctPst" templateKey="W_PiceRtrivlLctPst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
              ...
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_CaseRtrivlLctPst" templateKey="W_CaseRtrivlLctPst"/></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
                <TD align=middle bgColor=#b8b7d7></TD>
