<%-- $Id: DefineReportDataStockMove.jsp,v 1.1.1.1 2006/08/17 09:33:27 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_RptClmSetStockMov" templateKey="W_RptClm_SetStockMov"/></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD bgColor=#b8b7d7><h:label id="lbl_ConsignorCode" templateKey="W_ConsignorCode"/></TD>
                ...
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7><h:label id="lbl_ConsignorName" templateKey="W_ConsignorName"/></TD>
                ...
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/></TD>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD bgColor=#b8b7d7><h:label id="lbl_CaseEntering" templateKey="W_CaseEntering"/></TD>
                ...
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7><h:label id="lbl_MoveQtyPieceTotal" templateKey="W_MoveQtyPieceTotal"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_MovQtyPtl" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_MovQtyPtlLen" templateKey="W_MovQtyPtlLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenMovQtyPtl" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_MovQtyPtlPst" templateKey="W_MovQtyPtlPst"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7><h:label id="lbl_FromMoveLocation" templateKey="W_FromMoveLocation"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_FromMovLct" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_FromMovLctLen" templateKey="W_FrmMovLctLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenFromMovLct" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_FromMovLctPst" templateKey="W_FrmMovLctPos"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD bgColor=#b8b7d7><h:label id="lbl_ToMoveLocation" templateKey="W_ToMoveLocation"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_ToMovLct" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_ToMovLctLen" templateKey="W_ToMovLctLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenToMovLct" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_ToMovLctPst" templateKey="W_ToMovLctPos"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD bgColor=#b8b7d7><h:label id="lbl_MoveResultDate" templateKey="W_MoveResultDate"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_MovRsltDate" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_MovRsltDateLen" templateKey="W_MovRsltDateLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:label id="lbl_MaxLenMovRsltDate" templateKey="W_MaxLen"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_MovRsltDatePst" templateKey="W_MovRsltDatePos"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR>
