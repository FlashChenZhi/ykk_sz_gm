<%-- $Id: SortingPlanList.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_Display")
		{
			...
			else if (!_isValueInput('txt_PickingPlanDate'))
			{
				document.all('txt_PickingPlanDate').focus();
				// 6023012=仕分予定日を入力してください。
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023012") %>',2);
				return true;
			}
		}
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PicknigPlanDate" templateKey="W_PickingPlanDate"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="W_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_WorkStatusSorting" templateKey="W_Status"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
