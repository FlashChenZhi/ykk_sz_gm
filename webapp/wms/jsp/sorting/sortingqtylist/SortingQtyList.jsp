<%-- $Id: SortingQtyList.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_Display")
		{
			...
			else if (!_isValueInput('txt_PickingDate'))
			{
				document.all('txt_PickingDate').focus();
				// 6023044=仕分け日を入力してください。
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023044") %>',2);
				return true;
			}
		}
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PickingDate" templateKey="W_PickingDate"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_PickingDate" templateKey="W_PickingDate"/><h:submitbutton id="btn_PSearchPickingDate" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
