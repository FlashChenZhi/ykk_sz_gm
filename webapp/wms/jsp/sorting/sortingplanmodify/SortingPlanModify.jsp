<%-- $Id: SortingPlanModify.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_WorkerCode" templateKey="W_WorkerCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_Password" templateKey="W_Password"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_Password" templateKey="W_Password"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:datetextbox id="txt_PickingPlanDate" templateKey="W_PickingPlanDate"/><h:submitbutton id="btn_PSearchPickingPlanDate" templateKey="P_Search"/></TD>
                <TD width="5%" bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD>
                <TD width="90%" bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_PSearchPickPlan" templateKey="W_P_PickPlanSrch"/></TD></TR>
              <TR>
