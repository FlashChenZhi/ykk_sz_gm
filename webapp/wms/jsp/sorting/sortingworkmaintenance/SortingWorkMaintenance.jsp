<%-- $Id: SortingWorkMaintenance.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CrossDCFlag" templateKey="W_CrossDCFlag"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_CrossDCFlagAll" templateKey="W_CrossDCFlag_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  ...
                  <h:radiobutton id="rdo_CrossDCFlagDC" templateKey="W_CrossDCFlag_DC"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:datetextbox id="txt_RPickingPlanDate" templateKey="W_R_PickingPlanDate"/></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD><h:label id="lbl_Item" templateKey="W_Item"/></TD>
                      <TD><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                      <TD><h:freetextbox id="txt_RItemCode" templateKey="W_R_ItemCode"/></TD>
                      <TD><h:freetextbox id="txt_RItemName" templateKey="W_R_ItemName"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SSortingWorkMaintenance" templateKey="W_S_SortingWorkMaintenance"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
