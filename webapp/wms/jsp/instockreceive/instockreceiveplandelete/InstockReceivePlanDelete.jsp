<%-- $Id: InstockReceivePlanDelete.jsp,v 1.1.1.1 2006/08/17 09:33:17 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StrtInstkPlanDate" templateKey="W_StrtInstkPlanDate"/><h:submitbutton id="btn_PSearchStrtInstkPlanDate" templateKey="P_Search"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:label id="lbl_EndInstockPlanDate" templateKey="W_EndInstockPlanDate"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:datetextbox id="txt_EdInstkPlanDate" templateKey="W_EdInstkPlanDate"/><h:submitbutton id="btn_PSearchEdInstkPlanDate" templateKey="P_Search"/></TD></TR>
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_CrossDCFlagAll" templateKey="W_CrossDCFlag_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CrossDCFlagTC" templateKey="W_CrossDCFlag_TC"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_InstkPlanDltList" templateKey="W_InstkPlanDltList"/></TD>
                <TD noWrap bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD noWrap bgColor=#b8b7d7><h:checkbox id="chk_CommonUse" templateKey="W_CommonUse"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:label id="txt_Consignor" templateKey="W_Consignor"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_RConsignorCode" templateKey="W_R_ConsignorCode"/>&nbsp;<h:freetextbox id="txt_RConsignorName" templateKey="W_R_ConsignorName"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SInstkRcvPlanDelete" templateKey="W_S_InstockReceivePlanDelete"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
