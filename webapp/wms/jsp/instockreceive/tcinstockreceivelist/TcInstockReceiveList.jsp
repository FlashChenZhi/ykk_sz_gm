<%-- $Id: TcInstockReceiveList.jsp,v 1.1.1.1 2006/08/17 09:33:18 mori Exp $ --%>
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_PDisplay")
		{
			...
			else if (!_isValueInput('txt_InstockPlanDate'))
			{
				document.all('txt_InstockPlanDate').focus();
				// 6023008=入荷予定日を入力してください。
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023008") %>',2);
				return true;
			}
		}
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_TicTkt" templateKey="W_Tic_Tkt"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_TicItem" templateKey="W_Tic_Item"/></TD></TR>
              <TR bgColor=#b8b7d7>
