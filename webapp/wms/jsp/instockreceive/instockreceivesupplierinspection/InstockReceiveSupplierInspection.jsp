<%-- $Id: InstockReceiveSupplierInspection.jsp,v 1.1.1.1 2006/08/17 09:33:18 mori Exp $ --%>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <TABLE>
                    ...
                    <TR>
                      ...
                      <TD><h:freetextbox id="txt_RSupplierName" templateKey="W_R_SupplierName"/></TD></TR></TBODY></TABLE></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_InstkRcvSplIsp" templateKey="W_S_InstockReceiveSupplierInspection"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
