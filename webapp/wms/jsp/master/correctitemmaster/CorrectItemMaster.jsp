<%-- $Id: CorrectItemMaster.jsp,v 1.1.1.1 2006/08/17 09:33:19 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_itemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_ItemSearch" templateKey="P_Search"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
