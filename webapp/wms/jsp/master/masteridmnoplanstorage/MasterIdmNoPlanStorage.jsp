<%-- $Id: MasterIdmNoPlanStorage.jsp,v 1.1.1.1 2006/08/17 09:33:19 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_StorageBank" templateKey="W_StorageBank"/><h:label id="lbl_Hyphn1" templateKey="W_Hyphn"/><h:freetextbox id="txt_StorageBay" templateKey="W_StorageBay"/><h:label id="lbl_Hyphn2" templateKey="W_Hyphn"/><h:freetextbox id="txt_StorageLevel" templateKey="W_StorageLevel"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:submitbutton id="btn_PSearchEmpLocation" templateKey="W_P_IdmEmptyLocationSearch"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:submitbutton id="btn_PSearchReplenishLocation" templateKey="W_P_IdmReplenishLocationSearch"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD></TD>
                <TD></TD>
                <TD colSpan=4></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=3><h:freetextbox id="txt_ConsignorCode" templateKey="W_ConsignorCode"/><h:submitbutton id="btn_PSearchConsignor" templateKey="P_Search"/></TD>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=3><h:radiobutton id="rdo_CpfCase" templateKey="W_Cpf_Case"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:radiobutton id="rdo_CpfPiece" templateKey="W_Cpf_Piece"/>&nbsp;&nbsp;&nbsp;&nbsp; 
                  &nbsp;&nbsp; &nbsp;<h:radiobutton id="rdo_CpfAppointOff" templateKey="W_Cpf_AppointOff"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CpfAll" templateKey="W_Cpf_All"/></TD>
                <TD></TD>
                <TD></TD>
                <TD noWrap width=3 bgColor=#7371ab height=8></TD>
                <TD width="100%"></TD></TR>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=8><h:numbertextbox id="txt_CaseEntering" templateKey="W_CaseEntering"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_StrageCaseQty" templateKey="W_StrageCaseQty"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_StrgCaseQty" templateKey="W_StrgCaseQty"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_CaseItf" templateKey="W_CaseItf"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_CaseItf" templateKey="W_CaseItf"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_BundleEntering" templateKey="W_BundleEntering"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=8><h:numbertextbox id="txt_BundleEntering" templateKey="W_BundleEntering"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_StragePieseQty" templateKey="W_StragePieseQty"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_StrgPieseQty" templateKey="W_StrgPieseQty"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_BundleItf" templateKey="W_BundleItf"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_BundleItf" templateKey="W_BundleItf"/></TD></TR>
              <TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Idmschstwoli" templateKey="W_Unschstwoli"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_INoPlanStorage" templateKey="W_I_NoPlanStorage"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR height=8>
          ...
          <TD 
          background=<%=request.getContextPath()%>/img/common/bg_end.gif 
          height=8></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TR></TBODY></TABLE></h:page>
</h:html>
