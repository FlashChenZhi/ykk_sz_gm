<%-- $Id: MasterAsNoPlanRetrieval.jsp,v 1.2 2006/11/21 04:22:27 suresh Exp $ --%>
 ...
 *
 * @version $Revision: 1.2 $, $Date: 2006/11/21 04:22:27 $
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD bgColor=#dad9ee colSpan=7><h:freetextbox id="txt_WorkerCode" templateKey="W_WorkerCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:label id="lbl_PassWord" templateKey="W_Password"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_Password" templateKey="W_Password"/></TD></TR>
              <TR>
              ...
              <TR>
                ...
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#dad9ee colSpan=3><h:linkedpulldown id="pul_Station" templateKey="W_Station"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=4><h:radiobutton id="rdo_Cpf_All" templateKey="W_Cpf_All"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:formattextbox id="txt_StartLocation" templateKey="W_F_Location"/><h:submitbutton id="btn_PSStartLocation" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_FromTo" templateKey="W_FromTo"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_EndLocation" templateKey="W_EndLocation"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=2><h:formattextbox id="txt_EndLocation" templateKey="W_F_Location"/><h:submitbutton id="btn_PSEndLocation" templateKey="P_Search"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CaseItf" templateKey="W_CaseItf"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_CaseItf" templateKey="W_CaseItf"/><h:submitbutton id="btn_PSCaseItf" templateKey="P_Search"/>　</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_BundleItf" templateKey="W_BundleItf"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7 colSpan=2><h:freetextbox id="txt_BundleItf" templateKey="W_BundleItf"/><h:submitbutton id="btn_PSBundleItf" templateKey="P_Search"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7></TD>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=6><h:freetextbox id="txt_CustomerName" templateKey="W_CustomerName"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7 colSpan=3><h:label id="lbl_Unschretwoli" templateKey="W_Unschretwoli"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:checkbox id="chk_RetrievalPlanData" templateKey="W_CommonUse"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD>　&nbsp; </TD>
                <TD><h:submitbutton id="btn_RetrievalQtyClear" templateKey="W_RetrievalQtyClear"/>&nbsp;&nbsp;&nbsp;&nbsp;
                </TD>
                <TD><h:submitbutton id="btn_AllCheck" templateKey="W_AllCheck"/></TD>
                <TD></TD>
                <TD>　&nbsp;<h:submitbutton id="btn_allCheckClear" templateKey="W_AllCheckClear"/>&nbsp;&nbsp;
                  &nbsp;</TD>
          ...
          <TD>&nbsp;
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_NoPlanRetrieval" templateKey="W_NoPlanRetrieval"/></TD></TR></TBODY></TABLE>　</TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
