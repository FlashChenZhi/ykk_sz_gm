<%-- $Id: MasterRetrievalPlanRegist.jsp,v 1.1.1.1 2006/08/17 09:33:20 mori Exp $ --%>
...
<h:head>
  <script>
	...
	{
		if (targetElement == "btn_PRtrivlPlanSrch")
		{
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7 colSpan=10><h:freetextbox id="txt_WorkerCode" templateKey="W_WorkerCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_ConsignorCode" templateKey="W_ConsignorCode"/><h:submitbutton id="btn_PSearchConsignorCode" templateKey="P_Search"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ConsignorName" templateKey="W_ConsignorName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_ConsignorName" templateKey="W_ConsignorName"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RetrievalPlanDate" templateKey="W_RetrievalPlanDate"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:datetextbox id="txt_RtrivlPlanDate" templateKey="W_RtrivlPlanDate"/><h:submitbutton id="btn_PSearchRetrievalPlanDate" templateKey="P_Search"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_PSearchItemCode" templateKey="P_Search"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD>
                <TD>&nbsp;&nbsp;<h:submitbutton id="btn_PRtrivlPlanSrch" templateKey="W_P_RtrivlPlanSrch"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemName" templateKey="W_ItemName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_ItemName" templateKey="W_ItemName"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:radiobutton id="rdo_CpfCase" templateKey="W_Cpf_Case"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_RetrievalLocation" templateKey="W_RetrievalLocation"/><h:submitbutton id="btn_PSearchRetrievalLocation" templateKey="P_Search"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_PSearchCustomerCode" templateKey="P_Search"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerName" templateKey="W_CustomerName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_CustomerName" templateKey="W_CustomerName"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_OrderNo" templateKey="W_OrderNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=8><h:freetextbox id="txt_OrderNo" templateKey="W_OrderNo"/><h:submitbutton id="btn_PSearchOrderNo" templateKey="P_Search"/><h:label id="lbl_NoOrderItemPicking" templateKey="W_NoOderItemPicking"/></TD>
                <TD noWrap width=3 bgColor=#7371ab height=3></TD></TR>
              <TR>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7 colSpan=7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_CaseItf" templateKey="W_CaseItf"/></TD></TR>
              <TR>
                ...
                <TD bgColor=#b8b7d7 colSpan=7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_BundleItf" templateKey="W_BundleItf"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_TicketNo" templateKey="W_TicketNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_TicketNo" templateKey="W_TicketNo"/></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_LineNo" templateKey="W_LineNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_LineNo" templateKey="W_LineNo"/></TD>
                <TD bgColor=#b8b7d7 
        colSpan=7></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD></TD></TR></TBODY></TABLE><h:submitbutton id="btn_Input" templateKey="W_Input"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_Clear" templateKey="Clear"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SRetrievalPlanRegist" templateKey="W_S_RetrievalPlanRegist"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7>&nbsp;</TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
