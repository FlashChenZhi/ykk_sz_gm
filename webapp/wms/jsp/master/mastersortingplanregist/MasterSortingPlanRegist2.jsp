<%-- $Id: MasterSortingPlanRegist2.jsp,v 1.1.1.1 2006/08/17 09:33:20 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD colSpan=6><h:label id="lbl_JavaSetConsgnorName" templateKey="W_JavaSet"/></TD></TR>
              <TR bgColor=#dad9ee>
                ...
                <TD bgColor=#dad9ee colSpan=6></TD></TR>
              <TR>
                ...
                <TD bgColor=#dad9ee colSpan=6><h:label id="lbl_JavaSetItemName" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                ...
                <TD bgColor=#dad9ee><h:label id="lbl_CaseItf" templateKey="W_CaseItf"/></TD>
                <TD bgColor=#dad9ee colSpan=5><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:label id="lbl_JavaSetCaseItf" templateKey="W_JavaSet"/></TD></TR>
              <TR bgColor=#dad9ee>
                ...
                <TD bgColor=#dad9ee><h:label id="lbl_BundleItf" templateKey="W_BundleItf"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                </TD>
                <TD bgColor=#dad9ee colSpan=5><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:label id="lbl_JavaSetBundleItf" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:radiobutton id="rdo_CpfCase" templateKey="W_Cpf_Case"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CpfPiece" templateKey="W_Cpf_Piece"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CrossDCTwoByte" templateKey="W_CrossDCTwoByte"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:radiobutton id="rdo_CrossDCFlagCross" templateKey="W_CrossDCFlag_Cross"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_CrossDCFlagDC" templateKey="W_CrossDCFlag_DC"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_PSearchCustomerCode" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerName" templateKey="W_CustomerName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_CustomerName" templateKey="W_CustomerName"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                ...
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_ShippingTicketLineNo" templateKey="W_ShpTktLineNo"/></TD>
                <TD bgColor=#b8b7d7></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_PlanPieceQty" templateKey="W_PlanPieceQty"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PickingPlace" templateKey="W_PickingPlace"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_PickingPlace" templateKey="W_SortingLocation"/><h:submitbutton id="btn_PSearchPickingPlace" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SupplierCode" templateKey="W_SupplierCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_SupplierCode" templateKey="W_SupplierCode"/><h:submitbutton id="btn_PSearchSupplierCode" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_SupplierName" templateKey="W_SupplierName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:freetextbox id="txt_SupplierName" templateKey="W_SupplierName"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_InstockTicketNo" templateKey="W_InstockTicketNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:freetextbox id="txt_InstockTicketNo" templateKey="W_InstockTicketNo"/></TD>
                <TD bgColor=#b8b7d7><h:label id="lbl_InstockTicketLineNo" templateKey="W_InstkTktLineNo"/></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:numbertextbox id="txt_InstockTicketLineNo" templateKey="W_InstkTktLineNo"/></TD>
                <TD bgColor=#b8b7d7></TD>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SortingPlanRegist" templateKey="W_S_SortingPlanRegist"/></TD>
                <TD width="100%" 
