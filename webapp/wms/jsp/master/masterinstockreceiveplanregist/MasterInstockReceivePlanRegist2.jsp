<%-- $Id: MasterInstockReceivePlanRegist2.jsp,v 1.1.1.1 2006/08/17 09:33:19 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD><h:label id="lbl_JavaSetCnsgnrCd" templateKey="W_JavaSet"/></TD>
                <TD colSpan=8>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_JavaSetCnsgnrNm" templateKey="W_JavaSet"/></TD></TR>
              <TR>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7 colSpan=9><h:numbertextbox id="txt_LineNo" templateKey="W_LineNo"/></TD></TR>
              <TR bgColor=#b8b7d7>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:freetextbox id="txt_BundleItf" templateKey="W_BundleItf"/></TD>
                <TD bgColor=#b8b7d7 
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            ...
            <h:submitbutton id="btn_AllCancel" templateKey="W_AllCancel"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp; </TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_SInstkRcvPlanRst" templateKey="W_S_InstockReceivePlanRegist"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
