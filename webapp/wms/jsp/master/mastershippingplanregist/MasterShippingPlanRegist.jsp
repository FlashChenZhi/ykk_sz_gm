<%-- $Id: MasterShippingPlanRegist.jsp,v 1.1.1.1 2006/08/17 09:33:20 mori Exp $ --%>
...
<h:head>
  <script>
	...
	{
		if (targetElement == "btn_PShpPlanSrch")
		{
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width=775 border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD></TD>
                <TD></TD>
                <TD noWrap width=3 bgColor=#7371ab height=8></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ConsignorName" templateKey="W_ConsignorName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_ConsignorName" templateKey="W_ConsignorName"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_ShippingPlanDate" templateKey="W_ShippingPlanDate"/><h:submitbutton id="btn_PSearchShp" templateKey="P_Search"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD noWrap width=3 bgColor=#7371ab height=8></TD>
                <TD>&nbsp;&nbsp; <h:submitbutton id="btn_PShpPlanSrch" templateKey="W_P_ShpPlanSrch"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_CustomerCode" templateKey="W_CustomerCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_CustomerCode" templateKey="W_CustomerCode"/><h:submitbutton id="btn_PSearchCust" templateKey="P_Search"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_TicketNo" templateKey="W_TicketNo"/><h:submitbutton id="btn_PSearchTkt" templateKey="P_Search"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
