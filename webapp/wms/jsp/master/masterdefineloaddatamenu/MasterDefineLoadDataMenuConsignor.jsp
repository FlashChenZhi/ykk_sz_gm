<%-- $Id: MasterDefineLoadDataMenuConsignor.jsp,v 1.1.1.1 2006/08/17 09:33:19 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_LodClm_SetCon" templateKey="W_LodClm_SetCon"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD align=middle bgColor=#b8b7d7><h:checkbox id="chk_CnsgnrName" templateKey="W_CommonUse"/></TD>
                <TD align=middle bgColor=#b8b7d7><h:numbertextbox id="txt_CnsgnrName" templateKey="W_CnsgnrNmLen"/></TD>
