<%-- $Id: DeadStockList.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%> 
  ...
  <script>
	function dynamicAction()
	{
		if (targetElement == "btn_PDisplay")
		{
			...
			else if (!_isValueInput('txt_StorageDate')) 
			{
				document.all('txt_StorageDate').focus();
				// 6023176=入庫日を入力してください。
				_setMessage('<%= jp.co.daifuku.bluedog.util.MessageResources.getText("6023176") %>',2);
				return true;
			}
		}
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_StorageDate" templateKey="W_StorageDate"/><h:label id="lbl_Osil" templateKey="W_Osil"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
