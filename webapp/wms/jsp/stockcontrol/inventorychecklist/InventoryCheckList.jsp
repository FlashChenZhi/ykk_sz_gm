<%-- $Id: InventoryCheckList.jsp,v 1.1.1.1 2006/08/17 09:33:24 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_StartLocation" templateKey="W_StartLocation"/><h:submitbutton id="btn_PSearchStrtLct" templateKey="P_Search"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:label id="lbl_EndLocation" templateKey="W_EndLocation"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_EndLocation" templateKey="W_EndLocation"/><h:submitbutton id="btn_PSearchEndLct" templateKey="P_Search"/></TD></TR>
              <TR>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_PrintCondition" templateKey="W_PrintCondition"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_GrpItemCdStrgDate" templateKey="W_Grp_ItemCdStrgDate"/>&nbsp;&nbsp; <h:radiobutton id="rdo_GrpGrpOff" templateKey="W_Grp_GrpOff"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_QtyPrintOn" templateKey="W_QtyPrintOn"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  &nbsp;<h:radiobutton id="rdo_QtyPrintOff" templateKey="W_QtyPrintOff"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
