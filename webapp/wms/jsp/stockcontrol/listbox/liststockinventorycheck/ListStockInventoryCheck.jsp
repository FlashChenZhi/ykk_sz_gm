<%-- $Id: ListStockInventoryCheck.jsp,v 1.1.1.1 2006/08/17 09:33:25 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_GroupFlag" templateKey="W_GroupFlag"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetGroupFlag" templateKey="W_JavaSet"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  <TABLE cellSpacing=0 cellPadding=0 align=right bgColor=#dad9ee 
            border=0>
              ...
              <TR>
                ...
                <TD width=7 height=10><IMG height=1 src="<%=request.getContextPath()%>//img/common/spacer.gif" width=7 border=0></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><BR>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_InventoryList" templateKey="W_InventoryList"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
                ...
                <TD align=right height=10>
                  <TABLE cellSpacing=0 cellPadding=0 bgColor=#b8b7d7 border=0>
                    ...
                    <TR>
                      ...
                      <TD></TD>
                      <TD width=7 height=7><IMG height=1 src="<%=request.getContextPath()%>//img/common/spacer.gif" width=7 border=0></TD></TR></TBODY></TABLE></TD>
                <TD width=7 height=10><IMG height=1 src="<%=request.getContextPath()%>//img/common/spacer.gif" width=7 border=0></TD></TR></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
