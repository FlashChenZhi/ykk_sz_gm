<%-- $Id: ListAsrsStoragePlan.jsp,v 1.1.1.1 2006/08/17 09:33:15 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <%-- display --%>
  <TABLE style="MARGIN-LEFT: 7px; WIDTH: 118px; HEIGHT: 113px" 
            cellSpacing=0 cellPadding=0 bgColor=#dad9ee border=0>
              <TBODY>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetCnsgnrCd" templateKey="W_JavaSet"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h:label id="lbl_JavaSetCnsgnrNm" templateKey="W_JavaSet"/>&nbsp; 　　　 </TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee><h:label id="lbl_7" templateKey="W_StoragePlanDate"/></TD>
                <TD width="100%" bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:datetextbox id="txt_FDateStrt" templateKey="W_F_Date"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee><h:label id="lbl_Item" templateKey="W_Item"/></TD>
                <TD width="100%" bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
              ...
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee><h:label id="lbl_CasePieceFlag" templateKey="W_CasePieceFlag"/></TD>
                <TD width="100%" bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetCasePieceFlag" templateKey="W_JavaSet"/></TD></TR></TBODY></TABLE></TD>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_AsrsPlanList" templateKey="W_AsrsStoragePlanList"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
