<%-- $Id: ListAsOperationCycleItem.jsp,v 1.1.1.1 2006/08/17 09:33:15 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_SearchCondition" templateKey="W_SearchCondition"/></TD>
              ...
              <TR>
                ...
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetWareHouse" templateKey="W_JavaSet"/></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_DayTimeRange" templateKey="W_DayTimeRange"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:datetextbox id="txt_FDateStrt" templateKey="W_F_Date"/><h:timetextbox id="txt_FTimeStrt" templateKey="W_F_Time"/><h:label id="lbl_FromTo" templateKey="W_FromTo"/><h:datetextbox id="txt_FDateEnd" templateKey="W_F_Date"/><h:timetextbox id="txt_FTimeEnd" templateKey="W_F_Time"/></TD></TR>
              <TR bgColor=#dad9ee>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_MachineNo" templateKey="W_RMNo"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetMachineNo" templateKey="W_JavaSet"/></TD></TR></TBODY></TABLE></TD>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_AsrsOperationCycleItem" templateKey="W_AsrsOperationCycleItem"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
