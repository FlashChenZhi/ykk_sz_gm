<%-- $Id: ListAsLocationWorkingInquiry.jsp,v 1.1.1.1 2006/08/17 09:33:15 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
            bgColor=#dad9ee border=0>
              ...
              <TR bgColor=#dad9ee height=5>
                ...
                <TD></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_1" templateKey="W_WareHouse"/></TD>
              ...
              <TR bgColor=#dad9ee>
                ...
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetCnsgnrCd" templateKey="W_JavaSet"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:label id="lbl_JavaSetCnsgnrName" templateKey="W_JavaSet"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#dad9ee><h:label id="lbl_Location" templateKey="W_Location"/></TD>
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#dad9ee><h:label id="lbl_JavaSetStartLocation" templateKey="W_JavaSet"/> <h:label id="lbl_FromTo" templateKey="W_FromTo"/> <h:label id="lbl_JavaSetEndLocation" templateKey="W_JavaSet"/></TD></TR></TBODY></TABLE></TD>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_AsLocationWorkingInquiry" templateKey="W_AsLocationWorkingInquiry"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
