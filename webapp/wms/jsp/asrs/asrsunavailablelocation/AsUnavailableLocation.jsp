<%-- $Id: AsUnavailableLocation.jsp,v 1.1.1.1 2006/08/17 09:33:14 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7><h:formattextbox id="txt_location" templateKey="W_F_Location"/><h:submitbutton id="btn_LocationDetails" templateKey="P_LocationDetails"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Status" templateKey="W_Status"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:radiobutton id="rdo_Status_Prohibition" templateKey="W_Status_Prohibition"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:radiobutton id="rdo_Status_Possible" templateKey="W_Status_Possible"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
