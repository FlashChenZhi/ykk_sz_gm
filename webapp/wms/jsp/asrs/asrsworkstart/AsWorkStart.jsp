<%-- $Id: AsWorkStart.jsp,v 1.1.1.1 2006/08/17 09:33:14 mori Exp $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD bgColor=#b8b7d7 colSpan=6>&nbsp;</TD></TR>
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7>　　　 </TD>
                <TD bgColor=#b8b7d7><h:submitbutton id="btn_AllCheckClear" templateKey="W_AllCheckClear"/></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7 colSpan=5><h:listcell id="lst_AsrsWorkStart" templateKey="W_AsrsWorkStart"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
