<%-- $Id: StartStationStatusPopup.jsp,v 1.1.1.1 2006/08/17 09:33:15 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 align=right bgColor=#dad9ee 
      ...
      bgColor=#dad9ee border=0>
        ...
        <TR bgColor=#b8b7d7 width="100%">
          ...
          <TD bgColor=#b8b7d7><h:submitbutton id="btn_AllCheck" templateKey="W_AllCheck"/>&nbsp;&nbsp;&nbsp;<h:submitbutton id="btn_AllCheckClear" templateKey="W_AllCheckClear"/></TD>
        ...
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD>
          <TD bgColor=#b8b7d7><h:listcell id="lst_StartStationStatus" templateKey="W_StartStationStatus"/></TD>
          <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;</TD></TR>
        <TR bgColor=#b8b7d7>
          <TD bgColor=#b8b7d7></TD>
          <TD bgColor=#b8b7d7></TD>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_Setting" templateKey="Setting"/>&nbsp;&nbsp; 
                  <h:submitbutton id="btn_Reflesh" templateKey="Reflesh"/></TD>
