<%-- $Id: AsShelfMaintenance.jsp,v 1.1.1.1 2006/08/17 09:33:14 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#dad9ee><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#dad9ee><h:submitbutton id="btn_Query" templateKey="P_Query"/></TD>
                <TD bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee></TD>
                <TD bgColor=#dad9ee></TD>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=4><h:freetextbox id="txt_ConsignorCode" templateKey="W_ConsignorCode"/><h:submitbutton id="btn_PSConsignorcode" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_ConsignorName" templateKey="W_ConsignorName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ConsignorName" templateKey="W_ConsignorName"/></TD></TR>
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ItemCode" templateKey="W_ItemCode"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=4><h:freetextbox id="txt_ItemCode" templateKey="W_ItemCode"/><h:submitbutton id="btn_PSItemCode" templateKey="P_Search"/></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_ItemName" templateKey="W_ItemName"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_ItemName" templateKey="W_ItemName"/></TD></TR>
              <TR>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD bgColor=#b8b7d7 colSpan=2><h:datetextbox id="txt_StorageDate" templateKey="W_StorageDate"/></TD>
                <TD bgColor=#b8b7d7 colSpan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                  <h:label id="lbl_StorageTime" templateKey="W_StrageTime"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:timetextbox id="txt_StorageTime" templateKey="W_StorageTime"/>&nbsp; </TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
