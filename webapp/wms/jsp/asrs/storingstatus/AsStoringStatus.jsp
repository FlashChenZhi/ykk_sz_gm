<%-- $Id: AsStoringStatus.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#dad9ee border=0>
  ...
  <TABLE style="MARGIN-LEFT: 7px" cellSpacing=0 cellPadding=0 width="98%" 
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_RMNo" templateKey="W_RMNo"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:linkedpulldown id="pul_RMNo" templateKey="W_RMNo"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              <TBODY>
              <TR>
                <TD><h:submitbutton id="btn_Query" templateKey="View"/></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
                <TD></TD>
      ...
      <TABLE>
        ...
        <TR>
          <TD>&nbsp;&nbsp; </TD>
          <TD><h:listcell id="lst_AsStoringStatus" templateKey="W_AsStoringStatus"/></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
