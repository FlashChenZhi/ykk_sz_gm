<%-- $Id: Aisle.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_FBank" templateKey="AST_FBank"/>&nbsp;&nbsp;<h:label id="lbl_Hyphen1" templateKey="AST_Hyphen2"/>&nbsp;<h:freetextbox id="txt_TBank" templateKey="AST_TBank"/>&nbsp;&nbsp;&nbsp;&nbsp; <h:label id="lbl_AislePosition" templateKey="AST_AislePosition"/><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"><h:freetextbox id="txt_FAislePosition" templateKey="AST_FAislePosition"/><h:label id="lbl_And" templateKey="AST_And"/>&nbsp;<h:freetextbox id="txt_TAislePosition" templateKey="AST_TAislePosition"/>&nbsp;<h:label id="lbl_Space" templateKey="AST_Space"/></TD></TR>
              <TR>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_FLevel" templateKey="AST_FLevel"/><h:label id="lbl_Hyphen3" templateKey="AST_Hyphen2"/>&nbsp;<h:freetextbox id="txt_TLevel" templateKey="AST_TLevel"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
        ...
        <TR>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                <TD></TD>
                <TD><h:submitbutton id="btn_Add" templateKey="AST_Add"/>&nbsp; 
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD>&nbsp; &nbsp;</TD>
                <TD><h:submitbutton id="btn_Cancel" templateKey="AST_Cancel"/></TD></TR></TBODY></TABLE></TD>
