<%-- $Id: SystemDataTemp.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD width="100%" bgColor=#b8b7d7>
                  <CENTER><h:label id="lbl_SystemDataMsg" templateKey="AST_PreserveSystemDataMessage"/></CENTER></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7>
                  <CENTER><h:submitbutton id="btn_Start" templateKey="AST_Start"/></CENTER></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" 
