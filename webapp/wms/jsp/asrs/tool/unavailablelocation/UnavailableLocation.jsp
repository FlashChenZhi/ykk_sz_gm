<%-- $Id: UnavailableLocation.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
  ...
  <script>
     function dynamicAction()
     {
          if(event.srcElement.id == "btn_Cancel"){
               if(_isListcellEmpty('lst_UnUsableShelf'))
               {
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_ImpossibleLocation" templateKey="AST_ImpossibleLocation"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_Bank" templateKey="AST_Bank"/><h:label id="lbl_Hyphen1" templateKey="AST_Hyphen"/><h:freetextbox id="txt_Bay" templateKey="AST_Bay"/><h:label id="lbl_Hyphen2" templateKey="AST_Hyphen"/><h:freetextbox id="txt_Level" templateKey="AST_Level"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_UnUsableShelf" templateKey="AST_S_UnUsableShelf"/></TD></TR></TBODY></TABLE>&nbsp;</TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD>
<%-- footer --%>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
