<%-- $Id: WareHouse.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_WareHouseType" templateKey="AST_WareHouseType"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_AutomaticWareHouseSystem" templateKey="AST_AutomaticWareHouseSystem"/><h:radiobutton id="rdo_FloorLoadingWareHouseSys" templateKey="AST_FloorLoadingWareHouseSystem"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_AWCUseType" templateKey="AST_AWCUseType"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:radiobutton id="rdo_Open" templateKey="AST_Open"/><h:radiobutton id="rdo_Close" templateKey="AST_Close"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_MaxMixedQty" templateKey="AST_MaxMixedQty"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:numbertextbox id="txt_MaxMixedQty" templateKey="AST_MaxMixedQty"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
