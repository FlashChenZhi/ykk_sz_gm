<%-- $Id: IndividuallyHardZone.jsp,v 1.1.1.1 2006/08/17 09:33:16 mori Exp $ --%>
  ...
  <script>
     function dynamicAction()
     {
          if(event.srcElement.id == "btn_Cancel"){
               if(_isListcellEmpty('lst_HardZoneIndividual'))
               {
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:pulldown id="pul_ZoneId" templateKey="AST_ZoneId"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_LocNumber" templateKey="AST_LocNumber"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:freetextbox id="txt_Bank" templateKey="AST_Bank"/>&nbsp;<h:label id="lbl_Hyphen" templateKey="AST_Hyphen"/>&nbsp;<h:freetextbox id="txt_Bay" templateKey="AST_Bay"/>&nbsp;<h:label id="lbl_Hyphen2" templateKey="AST_Hyphen"/>&nbsp;<h:freetextbox id="txt_Level" templateKey="AST_Level"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7><h:listcell id="lst_HardZoneIndividual" templateKey="AST_S_HardZoneIndividual"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD width="100%" bgColor=#b8b7d7></TD></TR>
