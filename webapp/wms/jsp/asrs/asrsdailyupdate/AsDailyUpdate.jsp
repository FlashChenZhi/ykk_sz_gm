<%-- $Id: AsDailyUpdate.jsp,v 1.1.1.1 2006/08/17 09:33:14 mori Exp $ --%>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      border=0>
        ...
        <TR height=28>
          ...
          <TD width=7></TD>
          <TD noWrap><h:tab id="tab_DailyUpdate" templateKey="W_DailyUpdate"/></TD>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7><h:datetextbox id="txt_FDate" templateKey="W_F_Date"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7><h:label id="lbl_Upwi" templateKey="W_Upwi"/></TD>
                <TD bgColor=#b8b7d7><IMG src="<%=request.getContextPath()%>/img/common/icon_colon3.gif"></TD>
                <TD width="100%" bgColor=#b8b7d7>&nbsp;<h:radiobutton id="rdo_Delete" templateKey="W_Delete"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <h:radiobutton id="rdo_WorkInfoOrver" templateKey="W_WorkInfoOrver"/></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
