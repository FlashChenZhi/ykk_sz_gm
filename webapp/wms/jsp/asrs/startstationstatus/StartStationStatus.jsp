<%-- $Id: StartStationStatus.jsp,v 1.1.1.1 2006/08/17 09:33:15 mori Exp $ --%>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR bgColor=#b8b7d7>
                ...
                <TD bgColor=#b8b7d7>&nbsp;&nbsp; &nbsp;</TD>
                <TD width="100%" bgColor=#b8b7d7><h:submitbutton id="btn_AllCheckClear" templateKey="W_AllCheckClear"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7>&nbsp;&nbsp;&nbsp; </TD>
                <TD bgColor=#b8b7d7></TD>
              ...
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7 colSpan=4><h:listcell id="lst_StartStationStatus" templateKey="W_StartStationStatus"/></TD></TR>
              <TR bgColor=#b8b7d7>
                <TD noWrap bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
                <TD bgColor=#b8b7d7></TD>
          ...
          <TD bgColor=#b8b7d7>
            <TABLE cellSpacing=0 cellPadding=0 width=80 border=0>
              ...
              <TR>
                ...
                <TD></TD>
                <TD></TD>
                <TD><h:submitbutton id="btn_Reflesh" templateKey="Reflesh"/></TD></TR></TBODY></TABLE></TD>
