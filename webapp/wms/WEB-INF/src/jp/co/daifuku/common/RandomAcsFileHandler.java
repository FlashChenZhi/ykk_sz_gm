// $Id: RandomAcsFileHandler.java,v 1.1.1.1 2006/08/17 09:33:43 mori Exp $
...
public class RandomAcsFileHandler extends Object
{
	// Class fields --------------------------------------------------
	/**<jp>
	 * ログ・ファイルのデリミタ
...
//	protected String wPointerfileName ;
	...
	* 
	...
	public void write(int msgnum, String fac, String ci, Object[] param) throws IOException, NumberFormatException
	{
...
//		raf.skipBytes(Integer.parseInt(pointer)) ;
	...
	public void writeUTF(int msgnum, String fac, String ci, Object[] param) throws IOException, NumberFormatException
	{
		// create RandomAccessFile object
        File f = new File(wLogfileName) ;
		RandomAccessFile raf    = new RandomAccessFile(f, "rw") ;
	...
	public boolean readOpen(boolean readFlag) throws IOException
	{
		// close stream if opened
		if (wRandAcsFReader != null)
		{
	...
	public boolean readOpenUTF() throws IOException
	{
	...
	public boolean readOpenUTF(boolean readFlag) throws IOException
	{
		// close stream if opened
		if (wRandAcsFReader != null)
		{
...
//		}
		...
		Date dt = MSG_DATE_FORMATTER.parse(wst, new ParsePosition(0)) ;
	...
	public LogMessage readNextUTF() throws IOException
	{
		//<jp> 3バイト文字数を保持する変数</jp>
	...
	public Vector read(int start, int end) throws IOException
	{
...
System.out.println("start="+start+" end="+ end);
	...
	public Vector readUTF(int start, int end) throws IOException
	{
		Vector vec = new Vector(100);
		int loopcount = end - start;
		int cuurentlen = (int)wRandAcsFReader.length() ;
	...
	public Vector readBack(int start, int end) throws IOException
	{
	...
	public String getWritePointer(RandomAccessFile raFile) throws IOException
	{
		String pointer = "0" ;
		try
		{
	 ...
	 * @throws IOException It notifies the abnormality in reading file.
	 ...
	 private void setWritePointer(int size, RandomAccessFile raFile) throws IOException
	 {
	...
	private String fillChar(int digit, String str) throws IOException
	{
		//<jp>項目の長さを取得（バイト数）</jp>
