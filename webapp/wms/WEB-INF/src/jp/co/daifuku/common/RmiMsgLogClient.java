// $Id: RmiMsgLogClient.java,v 1.1.1.1 2006/08/17 09:33:43 mori Exp $
...
public class RmiMsgLogClient extends Object
{
	// Class fields --------------------------------------------------
...
/*  2004/01/19  MODIFY  M.KAWASHIMA START  */
				String filename = RmiMsgLogServer.MESSAGELOG_PATH + RmiMsgLogServer.getCurrentLogFileName();
				MessageLogHandler mh = new MessageLogHandler(filename) ;
				...
				{
					filename = RmiMsgLogServer.MESSAGELOG_PATH +  RmiMsgLogServer.getNewLogFileName();
					mh = new MessageLogHandler(filename) ;
				}
...
/*  2004/01/19  MODIFY  M.KAWASHIMA END  */
	...
	{
		return (write(RmiSendClient.RMI_REG_SERVER, mnum, fac, ci, param)) ;
	}
	...
	{
		return (write(RmiSendClient.RMI_REG_SERVER, mnum, LogMessage.getFacility(mnum), ci, param)) ;
	}
	...
	{
		return (write(RmiSendClient.RMI_REG_SERVER, mnum, fac, ci, null)) ;
	}
	...
	{
		return (write(RmiSendClient.RMI_REG_SERVER, mnum, LogMessage.getFacility(mnum), ci, null)) ;
	}
	...
	public static boolean write(TraceHandler tracehdl, String ci, Object[] param)
	{
		...
		int   mnum = tracehdl.getMessageNumber() ;
		String fac = LogMessage.getFacility(mnum) ;
		return (write(RmiSendClient.RMI_REG_SERVER, mnum, fac, ci, sparams)) ;
	}
	/**<jp>
	 * デフォルトのRMIレジストリ・サーバを利用してしてメッセージログを書き込みます。<BR>
	...
	public static boolean write(String msg, String ci) 
	{
		try
		{
			...
			return (write(RmiSendClient.RMI_REG_SERVER, mnum, LogMessage.getFacility(mnum), ci, params)) ;
		}
		catch (Exception e)
		{
	...
	public static boolean writeWarningMessage(String unsupop)
	{
		...
		param[1]   = unsupop ;
		return (write(RmiSendClient.RMI_REG_SERVER, 6020047, 
				LogMessage.getFacility(6020047), stack[3].getName(), param)) ;
	}
