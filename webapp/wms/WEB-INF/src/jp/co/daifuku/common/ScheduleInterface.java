// $Id: ScheduleInterface.java,v 1.1.1.1 2006/08/17 09:33:43 mori Exp $
...
public interface ScheduleInterface
{
	 ...
	 * @param <code>Locale</code> object set with the local code
	 ...
	 * @param conn Connection object with database
	 * @param <code>Locale</code> object, set with local code
