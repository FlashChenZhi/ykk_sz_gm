// $Id: MessageResource.java,v 1.1.1.1 2006/08/17 09:33:43 mori Exp $
...
public class MessageResource extends Object
{
	 ...
	 * @return       パラメータの文字列表現
	 * @deprecated Don't need to set locale.
	 </jp>*/
	/**<en>
...
//		getBundle(getResourceName(), getLocale()) ;
	...
	{
		String key = MSG_NUM_FORMAT.format(num) ;
//		try
//		{
...
//		}
	...
	// Private methods -----------------------------------------------
	private void getBundle(String res, Locale locale)
	{
		wRB = ResourceBundle.getBundle(res, locale) ;
	}
