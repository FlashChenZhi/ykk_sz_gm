// $Id: TraceHandler.java,v 1.1.1.1 2006/08/17 09:33:44 mori Exp $
...
public class TraceHandler
{
	...
	private int wDefaultMessageNum = 0 ;
	...
	{
		wDefaultMessageNum = defaultmsgnum ;
		wException         = e ;
	}
	 ...
	 * @param param  メッセージ・ログへ書き込むパラメータに
	 * @return メッセージ番号
	 </jp>*/
	/**<en>
	 ...
	 * @param param  Parameter that writes in message log
	 * @return Message number
	 </en>*/
	public int getMessageNumber()
	{
//		String msg = wException.getMessage() ;
//		int msgnum = 0;
//		try
//		{
...
//		return msgnum ;
	...
	public String getStackTrace()
	{
		...
		wException.printStackTrace(new PrintWriter(sw)) ;
		return (comment + sw.toString()) ;
	}
