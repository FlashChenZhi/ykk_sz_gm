//$Id: InOutResultReportFinder.java,v 1.2 2006/11/09 07:52:59 suresh Exp $
...
/**
 * This class searches the Inoutresult in the database and map it with TestView
 ...
 */
public class InOutResultReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public InOutResultReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:52:59 $") ;
	}
