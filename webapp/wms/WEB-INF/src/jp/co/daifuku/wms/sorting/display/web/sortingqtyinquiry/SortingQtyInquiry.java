// $Id: SortingQtyInquiry.java,v 1.1.1.1 2006/08/17 09:34:33 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class SortingQtyInquiry extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_PickingDate = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_PickingDate" , "W_PickingDate");
	public jp.co.daifuku.bluedog.ui.control.DateTextBox txt_PickingDate = jp.co.daifuku.bluedog.ui.control.DateTextBoxFactory.getInstance("txt_PickingDate" , "W_PickingDate");
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_PSearchPickingDate = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_PSearchPickingDate" , "P_Search");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_SPickingDate = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_SPickingDate" , "W_PickingDate");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SortingQtyInquiry = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SortingQtyInquiry" , "W_S_SortingQtyInquiry");
