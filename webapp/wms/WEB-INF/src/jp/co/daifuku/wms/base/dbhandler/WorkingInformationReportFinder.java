//$Id: WorkingInformationReportFinder.java,v 1.2 2006/11/09 07:50:13 suresh Exp $
...
/**
 * This class searches the Workinfo in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:13 $
 * @author  $Author: suresh $
 */
public class WorkingInformationReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WorkingInformationReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:13 $") ;
	}
