// $Id: ListShippingPlanList.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListShippingPlanList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ShippingPlanList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ShippingPlanList" , "W_ShippingPlanList");
