// $Id: ErroMessageInfoBusiness.java,v 1.1 2007/12/13 06:25:09 administrator Exp $
 ...
 */
public class ErroMessageInfoBusiness extends ErroMessageInfo implements
		WMSConstants
{
	// Class fields --------------------------------------------------
	...
	{
		session.setAttribute(ERROR_MESSAGE_INFO_HEAD,
				new ErrorMessageInfoHead());

		try
		{
			PulldownManager.FillErrorMessagePullDown(pul_MessageDivision);
		}
	...
	{
		setHeadSession();
		redirect("/YkkGMAX/Inquiry/ErroMessageInfoPopup.do", null,
				"/progress.do");
	}

	private void setHeadSession()
	{
		ErrorMessageInfoHead head = new ErrorMessageInfoHead();
		...
		session.setAttribute(ERROR_MESSAGE_INFO_HEAD, head);
