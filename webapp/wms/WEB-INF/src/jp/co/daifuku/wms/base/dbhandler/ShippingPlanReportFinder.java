//$Id: ShippingPlanReportFinder.java,v 1.2 2006/11/09 07:50:42 suresh Exp $
...
/**
 * This class searches the Shippingplan in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:42 $
 * @author  $Author: suresh $
 */
public class ShippingPlanReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ShippingPlanReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:42 $") ;
	}
