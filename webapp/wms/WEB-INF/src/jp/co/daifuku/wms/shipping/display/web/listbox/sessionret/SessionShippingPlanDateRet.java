// $Id: SessionShippingPlanDateRet.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * Maker : K.Matsuda <BR>
 * 
 * <CODE>SessionShippingPlanDateRet</CODE>クラスは、出荷予定情報テーブルより出荷予定日の検索を行い結果を保持するクラスです。<BR>
 ...
 * <BR>
 * 1.検索処理(<CODE>SessionShippingPlanDateRet(Connection conn, ShippingParameter param)</CODE>コンストラクタ)<BR>
 * 	<DIR>
 ...
 * @author  $Author: mori $
 */
public class SessionShippingPlanDateRet extends SessionRet
{
	// Class fields --------------------------------------------------
	 ...
	 */
	public SessionShippingPlanDateRet(Connection conn, ShippingParameter param) throws Exception
	{
		// コネクションの保持
		wConn = conn ;
	...
	// Public methods ------------------------------------------------
	/**
	 * 指定された件数分の出荷予定日を保持している一覧から取得します。
	 * 
	...
	private void find(ShippingParameter param) throws Exception
	{
		...
		// 検索条件をセット
		shippingPlanSearchKey.setPlanDateCollect("");
		...
		shippingPlanSearchKey.setPlanDateGroup(1);
