// $Id: ListSortingDate.java,v 1.1.1.1 2006/08/17 09:34:31 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListSortingDate extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ListSortingDate = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ListSortingDate" , "W_ListSortingDate");
