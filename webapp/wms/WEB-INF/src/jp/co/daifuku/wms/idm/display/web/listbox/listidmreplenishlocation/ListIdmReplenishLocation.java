// $Id: ListIdmReplenishLocation.java,v 1.1.1.1 2006/08/17 09:34:10 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListIdmReplenishLocation extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_Search = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_Search" , "W_SearchCondition");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ListReplenishLocation = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ListReplenishLocation" , "W_ReplenishLocation");
