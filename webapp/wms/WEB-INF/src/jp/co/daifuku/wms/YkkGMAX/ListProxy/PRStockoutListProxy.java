...
public class PRStockoutListProxy
{
	public PRStockoutListProxy(ListCell list, Page page)
	{
		this.list = list;
		this.page = page;
	}
	...
	private int MEMO_COLUMN = 2;

	private int WHEN_NEXT_WORK_BEGIN_COLUMN = 3;

	private int WHEN_THIS_WORK_FINISH_IN_PLAN_COLUMN = 4;

	private int ITEM_CODE_COLUMN = 5;

	private int ITEM_NAME_1_COLUMN = 6;

	private int ITEM_NAME_2_COLUMN = 19;

	private int ITEM_NAME_3_COLUMN = 20;

	private int COLOR_COLUMN = 7;

	private int STOCKOUT_NECESSARY_QTY_COLUMN = 8;

	private int MANAGEMENT_RETRIEVAL_QTY_COLUMN = 9;

	private int OUT_QTY_COLUMN = 10;

	private int STOCKOUT_COUNT_COLUMN = 11;

	private int ENABLE_TO_STOCKOUT_COUNT_COLUMN = 12;

	private int TOTAL_COUNT_INSTOCK_COLUMN = 13;
	
	private int RETRIEVAL_NO_COLUMN = 14;
	
	private int WAVES_RETRIEVAL_QTY_COLUMN = 15;
	
	private int PLAN_QTY_COLUMN = 16;

	private int RETRIEVAL_PLANKEY_COLUMN = 17;

	private int EXTERNAL_CODE_COLUMN = 18;
...
//		}
		list.setCellEnabled(AUTO_COLUMN, true);
	}
}
