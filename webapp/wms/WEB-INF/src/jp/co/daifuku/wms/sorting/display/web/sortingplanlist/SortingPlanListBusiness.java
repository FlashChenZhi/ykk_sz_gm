//$Id: SortingPlanListBusiness.java,v 1.1.1.1 2006/08/17 09:34:32 mori Exp $
...
import jp.co.daifuku.wms.sorting.display.web.listbox.listsortingplanlist.ListSortingPlanListBusiness;
import jp.co.daifuku.wms.sorting.schedule.SortingParameter;
import jp.co.daifuku.wms.sorting.schedule.SortingPlanListSCH;

/**
 * Designer : D.Hakui<BR>
 * Maker : D.Hakui<BR>
 * <BR>
 * 仕分予定リスト発行を行う画面クラスです。<BR>
 * 仕分予定リスト発行を行うスケジュールにパラメータを引き渡します。<BR>
 * <BR>
 * <DIR>
 ...
 * @author  $Author: mori $
 */
public class SortingPlanListBusiness extends SortingPlanList implements WMSConstants
{
	...
	// 結果画面ポップアップ呼び出しアドレス
	protected static final String DO_SRCH_PLANLIST = "/sorting/listbox/listsortingplanlist/ListSortingPlanList.do";
	// 検索ポップアップ呼び出し中画面アドレス
	...
	public void page_ConfirmBack(ActionEvent e) throws Exception
	{
		...
		try
		{
			...
			// スケジュールを開始する
			WmsScheduler schedule = new SortingPlanListSCH();
	 ...
	 * @throws Exception 
	 */
	public void lbl_StrtPickPlanDate_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void btn_PSearchStrtPickPlanDate_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lbl_EndPickingPlanDate_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_EndPickPlanDate_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_EndPickPlanDate_EnterKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void txt_EndPickPlanDate_TabKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void btn_PSearchEndPickingPlanDate_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void btn_PSearchEndPickingPlanDate_Click(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void W_CasePieceFlag_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void rdo_Cpf_CasePiece_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void rdo_Cpf_CasePiece_Click(ActionEvent e) throws Exception
	{
	}
	 ...
	 * <BR>
	 * 概要：入力エリアの入力項目をパラメータにセットし別画面仕分予定一覧リストボックスを表示します。<BR>
	 * 本メソッドでは以下の処理を行います。<BR>
	 * <BR>
	 * <DIR>
	 * 1.入力チェック（必須入力、文字数、文字属性）<BR>
	 * 2.入力項目をパラメータにセットする。<BR>
	 * 3.仕分予定一覧リストボックスを表示する。<BR>
	 * </DIR>
	 * 
	 * [パラメータ] *必須入力<BR>
	 * <DIR>
	...
	public void btn_Display_Click(ActionEvent e) throws Exception
	{
		...
		if (rdo_CpfAll.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CASEPIECEFLAG_KEY, SortingParameter.CASEPIECE_FLAG_ALL);
		}
		// ケース
		else if (rdo_CpfCase.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CASEPIECEFLAG_KEY, SortingParameter.CASEPIECE_FLAG_CASE);
		}
		// ピース
		else if (rdo_CpfPiece.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CASEPIECEFLAG_KEY, SortingParameter.CASEPIECE_FLAG_PIECE);
		}
		// ケース・ピース
		else if (rdo_CpfCasePiece.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CASEPIECEFLAG_KEY, SortingParameter.CASEPIECE_FLAG_MIXED);
		}
		...
		if (rdo_CrossDCFlagAll.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CROSSDC_KEY, SortingParameter.TCDC_FLAG_ALL);
		}
		// クロス
		else if (rdo_CrossDCFlagCross.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CROSSDC_KEY, SortingParameter.TCDC_FLAG_CROSSTC);
		}
		// DC
		else if (rdo_CrossDCFlagDC.getChecked())
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.CROSSDC_KEY, SortingParameter.TCDC_FLAG_DC);
		}
		...
		if (pul_WorkStatusSorting.getSelectedIndex() == 0)
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.STATUS_FLAG_KEY, SortingParameter.STATUS_FLAG_ALL);
		}
		// 未開始
		else if (pul_WorkStatusSorting.getSelectedIndex() == 1)
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.STATUS_FLAG_KEY, SortingParameter.STATUS_FLAG_UNSTARTED);
		}
		// 作業中
		else if (pul_WorkStatusSorting.getSelectedIndex() == 2)
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.STATUS_FLAG_KEY, SortingParameter.STATUS_FLAG_WORKING);
		}
		// 一部完了
		else if (pul_WorkStatusSorting.getSelectedIndex() == 3)
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.STATUS_FLAG_KEY, SortingParameter.STATUS_FLAG_PARTIAL_COMPLETION);
		}
		// 完了
		else if (pul_WorkStatusSorting.getSelectedIndex() == 4)
		{
			forwardParam.setParameter(ListSortingPlanListBusiness.STATUS_FLAG_KEY, SortingParameter.STATUS_FLAG_COMPLETION);
		}

		// 処理中画面->結果画面
		redirect(DO_SRCH_PLANLIST, forwardParam, DO_SRCH_PROCESS);
	}
