// $Id: SessionInstockReceiveQtyListRet.java,v 1.1.1.1 2006/08/17 09:34:13 mori Exp $
 ...
 * <BR>
 * <B>1.検索処理(<CODE>SessionInstockReceiveQtyListRet(Connection, InstockReceiveParameter)</CODE>メソッド)<BR></B>
 * <DIR>
 ...
 * @author  $Author: mori $
 */
public class SessionInstockReceiveQtyListRet extends SessionRet
{
	// Class fields --------------------------------------------------
	 ...
	 */
	public SessionInstockReceiveQtyListRet(Connection conn, InstockReceiveParameter param) throws Exception
	{
		this.wConn = conn;
	...
	private void find(InstockReceiveParameter param) throws Exception
	{
		...
		if (!StringUtil.isBlank(param.getTcdcFlag()))
		{
			...
			{
				viewKey.setTcdcFlag(ResultView.TCDC_FLAG_CROSSTC);
			...
			{
				viewKey.setTcdcFlag(ResultView.TCDC_FLAG_DC);
