//$Id: WorkingDataHandler.java,v 1.2 2006/11/09 07:50:16 suresh Exp $
...
/**
 * Database handler for WORKINGDATA
 *
...
public class WorkingDataHandler
		extends AbstractDBHandler
{
	 ...
	 */
	public WorkingDataHandler(Connection conn)
	{
	...
	{
		return "$Id: WorkingDataHandler.java,v 1.2 2006/11/09 07:50:16 suresh Exp $" ;
	}
