// $Id: SortingPlanRegistBusiness.java,v 1.1.1.1 2006/08/17 09:34:33 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class SortingPlanRegistBusiness extends SortingPlanRegist implements WMSConstants
{
	...
	protected static final String DO_REGIST = "/sorting/sortingplanregist/SortingPlanRegist.do";
	// 仕分予定登録(詳細情報登録画面)アドレス
	private static final String DO_REGIST2 = "/sorting/sortingplanregist/SortingPlanRegist2.do";
	// 検索ポップアップ呼び出し中画面アドレス
	...
	public void page_DlgBack(ActionEvent e) throws Exception
	{
		...
		// ケース入数
		String enteringQty = param.getParameter(ListSortingPlanRegistBusiness.ENTERING_KEY); 
		// ボール入数
		String bundleEnteringQty = param.getParameter(ListSortingPlanRegistBusiness.BUNDLEENTERING_KEY);
		// ケースITF
