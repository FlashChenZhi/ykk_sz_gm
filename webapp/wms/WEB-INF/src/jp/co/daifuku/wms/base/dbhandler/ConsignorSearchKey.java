//$Id: ConsignorSearchKey.java,v 1.2 2006/11/09 07:53:11 suresh Exp $
...
/**
 * This is the search key class for CONSIGNOR use.
 *
...
public class ConsignorSearchKey
		extends AbstractSQLSearchKey
{
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORCODE.toString(), arg);
	}
	/**
	 *Set search value for  Consignor code
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORCODE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Consignor code
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORCODE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.CONSIGNORCODE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.CONSIGNORCODE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.CONSIGNORCODE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.CONSIGNORCODE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORNAME.toString(), arg);
	}
	/**
	 *Set search value for  Consignor name
	 * @param arg String array
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORNAME.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Consignor name
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Consignor.CONSIGNORNAME.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.CONSIGNORNAME.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.CONSIGNORNAME.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.CONSIGNORNAME.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.CONSIGNORNAME.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEDATE.toString(), arg);
	}
	/**
	 *Set search value for  Last update date
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEDATE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last update date
	 * @param arg Set search value for Date
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEDATE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.LASTUPDATEDATE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.LASTUPDATEDATE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUPDATEDATE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUPDATEDATE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEPNAME.toString(), arg);
	}
	/**
	 *Set search value for  Last update name
	 * @param arg String array
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEPNAME.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last update name
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Consignor.LASTUPDATEPNAME.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.LASTUPDATEPNAME.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.LASTUPDATEPNAME.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUPDATEPNAME.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUPDATEPNAME.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Consignor.LASTUSEDDATE.toString(), arg);
	}
	/**
	 *Set search value for  Last used date
	 * @param arg Date array
	...
	{
		setValue(_Prefix + Consignor.LASTUSEDDATE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last used date
	 * @param arg Set search value for Date
	...
	{
		setValue(_Prefix + Consignor.LASTUSEDDATE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.LASTUSEDDATE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.LASTUSEDDATE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUSEDDATE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.LASTUSEDDATE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Consignor.DELETEFLAG.toString(), arg);
	}
	/**
	 *Set search value for  Delete flag
	 * @param arg String array
	...
	{
		setValue(_Prefix + Consignor.DELETEFLAG.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Delete flag
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Consignor.DELETEFLAG.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Consignor.DELETEFLAG.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Consignor.DELETEFLAG.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Consignor.DELETEFLAG.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Consignor.DELETEFLAG.toString(), compcode);
	}
	...
	{
		return "$Id: ConsignorSearchKey.java,v 1.2 2006/11/09 07:53:11 suresh Exp $" ;
	}
}
