// $Id: InventoryComplete.java,v 1.2 2006/12/07 08:57:50 suresh Exp $
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/12/07 08:57:50 $
...
public class InventoryComplete extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_PSearchEdLct = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_PSearchEdLct" , "P_Search");
	...
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_InventoryResult = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_InventoryResult" , "W_InventoryResult");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SInventoryComplete = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SInventoryComplete" , "W_InventoryComplete");
