//$Id: SupplierFinder.java,v 1.2 2006/11/09 07:50:28 suresh Exp $
...
/**
 * This class searches Supplier in the database and maps with TestView
 ...
 */
public class SupplierFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public SupplierFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:28 $") ;
	}
