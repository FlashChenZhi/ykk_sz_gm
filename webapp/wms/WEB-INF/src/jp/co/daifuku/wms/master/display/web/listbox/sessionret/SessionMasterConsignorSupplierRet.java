 ...
 * <BR>
 * 1.検索処理(<CODE>SessionConsignorSupplierRet(Connection conn,	MasterParameter param)</CODE>メソッド)<BR>
 * <DIR>
 ...
 */
public class SessionMasterConsignorSupplierRet extends SessionRet
{
	// Class fields -----------------------------------------------------
	 ...
	 */
	// Class variables -----------------------------------------------
	final protected String serchFlg = "1";
	 ...
	 */
	public SessionMasterConsignorSupplierRet(Connection conn, MasterParameter param) throws Exception
	{
		this.wConn = conn;
