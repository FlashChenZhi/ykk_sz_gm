// $Id: Id5520DataFile.java,v 1.1.1.1 2006/08/17 09:34:30 mori Exp $
...
/**
 * ID5121で送受信するデータファイルを操作するためのクラスです。
 * 
 * <p>
 * <table border="1">
 * <CAPTION>ID5520のファイルの各行の構造</CAPTION>
 ...
 * @author $Author: mori $
 */
public class Id5520DataFile extends IdDataFile
{
	// Class fields----------------------------------------------------
	/**
	 * 出荷先コードのオフセットの定義
	 ...
	 * 出荷先一覧ファイル名を表すフィールド
	 */
	static final String ANS_FILE_NAME = "ID5520.txt" ;

	/**
	 * インスタンスを生成します。
	 * @param filename ファイル名
	 */
	public Id5520DataFile(String filename)
	{
		super(filename);
	 ...
	 * 
	 * @param	obj				ファイルに書き込むデータWorkingInformation配列(Entityクラス)
	 * @throws IOException		ファイルの入出力中にエラーが発生した時に通知されます。
	 */
