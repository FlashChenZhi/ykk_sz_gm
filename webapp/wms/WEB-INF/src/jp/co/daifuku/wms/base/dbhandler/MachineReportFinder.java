//$Id: MachineReportFinder.java,v 1.2 2006/11/09 07:51:49 suresh Exp $
...
/**
 * This class searches the Machine in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:49 $
 * @author  $Author: suresh $
 */
public class MachineReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public MachineReportFinder(Connection conn)
	{
		super(conn, Machine.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:49 $") ;
	}
