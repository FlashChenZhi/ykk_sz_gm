// $Id: MasterIdmNoPlanRetrievalBusiness.java,v 1.2 2006/11/10 00:34:54 suresh Exp $
...
import jp.co.daifuku.wms.master.schedule.MasterIdmNoPlanRetrievalSCH;

/**
 * Designer : C.Kaminishizono <BR>
 * Maker : C.Kaminishizono <BR>
 * <BR>
 * マスタパッケージ導入時の移動ラック出庫設定画面クラスです。<BR>
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/10 00:34:54 $
 * @author  $Author: suresh $
 */
public class MasterIdmNoPlanRetrievalBusiness extends MasterIdmNoPlanRetrieval implements WMSConstants
{
	// Class fields --------------------------------------------------
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		try
		{
			...
			WmsScheduler schedule = new MasterIdmNoPlanRetrievalSCH();
			MasterIdmControlParameter param = (MasterIdmControlParameter) schedule.initFind(conn, null);
			
			if (MasterIdmControlParameter.MERGE_TYPE_OVERWRITE == param.getMergeType())
			{
	...
	public void btn_RetrievalStart_Click(ActionEvent e) throws Exception
	{
		...
		try
		{
			...
			MasterIdmControlParameter queryParam = new MasterIdmControlParameter();
			queryParam.setProcessType(MasterIdmControlParameter.PROCESS_TYPE_MERGE);
			...
			MasterIdmControlParameter[] mergeParam = (MasterIdmControlParameter[]) schedule.query(conn, queryParam);
			...
			for (int i = 1; i < index; i++)
			{
				...
				param.setProcessType(MasterIdmControlParameter.PROCESS_TYPE_QUERY);
			...
			MasterIdmControlParameter[] paramArray = new MasterIdmControlParameter[vecParam.size()];
