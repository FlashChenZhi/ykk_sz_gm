//$Id: WorkingDataReportFinder.java,v 1.2 2006/11/09 07:50:15 suresh Exp $
...
/**
 * This class searches the Workingdata in the database and map it with TestView
 ...
 */
public class WorkingDataReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WorkingDataReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:15 $") ;
	}
