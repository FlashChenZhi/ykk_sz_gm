 ...
 * Maker :  hota<BR>
 * <BR>
 * 荷主一覧リストボックス（マスタパッケージ 商品マスタ）用のデータを検索するためのクラスです。<BR>
 * 検索条件をパラメータとして受け取り、荷主一覧の検索を行います。<BR>
 * 尚、このクラスを使用する際はインスタンスをセッションに保持して下さい。
 * 使用後はセッションから削除して下さい。<BR>
 * このクラスでは以下の処理を行います。<BR>
 * <BR>
 * 1.検索処理(<CODE>SessionConsignorItemRet(Connection conn,	MasterParameter param)</CODE>メソッド)<BR>
 * <DIR>
 ...
 */
public class SessionMasterConsignorItemRet extends SessionRet
{
	// Class fields -----------------------------------------------------
	 ...
	 * 検索フラグ
	 */
	final protected String serchFlg = "3";
	// Class variables -----------------------------------------------
	 ...
	 */
	public SessionMasterConsignorItemRet(Connection conn, MasterParameter param) throws Exception
	{
		this.wConn = conn;
