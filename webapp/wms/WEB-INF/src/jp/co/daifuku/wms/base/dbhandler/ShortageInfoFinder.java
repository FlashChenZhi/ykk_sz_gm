//$Id: ShortageInfoFinder.java,v 1.2 2006/11/09 07:50:41 suresh Exp $
...
/**
 * This class searches Shortageinfo in the database and maps with TestView
 ...
 */
public class ShortageInfoFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ShortageInfoFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:41 $") ;
	}
