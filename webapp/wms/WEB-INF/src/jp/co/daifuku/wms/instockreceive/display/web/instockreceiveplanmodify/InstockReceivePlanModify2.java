// $Id: InstockReceivePlanModify2.java,v 1.1.1.1 2006/08/17 09:34:11 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class InstockReceivePlanModify2 extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label ID4 = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("ID4" , "W_Consignor");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SInstkRcvPlanModify = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SInstkRcvPlanModify" , "W_S_InstockReceivePlanModify");
