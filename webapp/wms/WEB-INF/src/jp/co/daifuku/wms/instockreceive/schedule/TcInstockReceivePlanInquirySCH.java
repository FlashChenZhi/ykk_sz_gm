 ...
 * Maker : K.Toda <BR>
 * <BR>
 * ＴＣ 入荷予定照会処理を行うためのクラスです。<BR>
 * 画面から入力された内容をパラメータとして受け取り、ＴＣ 入荷予定照会処理を行います。<BR>
 ...
 *   入荷予定日、仕入先コード、出荷先コード、伝票No、行No、商品コードの順に表示を行います。<BR>
 ...
 * @author  $
 */
public class TcInstockReceivePlanInquirySCH extends AbstractInstockReceiveSCH
{
	 ...
	 * このクラスの初期化を行ないます。
	 */
	public TcInstockReceivePlanInquirySCH()
	{
		wMessage = null;
	}
	...
	public Parameter[] query(Connection conn, Parameter searchParam) throws ReadWriteException, ScheduleException
	{
		...
		// 入荷予定日、仕入先コード、出荷先コード、伝票No、行No、商品コードの昇順でソート
