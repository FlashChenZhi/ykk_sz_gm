//$Id: AreaReportFinder.java,v 1.2 2006/11/09 07:53:20 suresh Exp $
...
/**
 * This class searches the Area in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:20 $
 * @author  $Author: suresh $
 */
public class AreaReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public AreaReportFinder(Connection conn)
	{
		super(conn, Area.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:20 $") ;
	}
