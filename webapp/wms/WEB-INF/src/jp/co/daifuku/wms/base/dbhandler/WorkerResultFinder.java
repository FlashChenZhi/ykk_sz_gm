//$Id: WorkerResultFinder.java,v 1.2 2006/11/09 07:50:19 suresh Exp $
...
/**
 * This class searches Workerresult in the database and maps with TestView
 ...
 */
public class WorkerResultFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WorkerResultFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:19 $") ;
	}
