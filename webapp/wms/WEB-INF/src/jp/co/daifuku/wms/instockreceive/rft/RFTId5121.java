// $Id: RFTId5121.java,v 1.1.1.1 2006/08/17 09:34:14 mori Exp $
...
/**
 * 入荷検品出荷先一覧応答 ID=5121 電文を作成します
 *
 * <p>
 * <table border="1">
 * <CAPTION>Id5121の電文の構造</CAPTION>
 * <TR><TH>項目名</TH>			<TH>長さ</TH>	<TH>内容</TH></TR>
 * <tr><td>STX</td>				<td>1 byte</td>	<td>0x02</td></tr>
 * <tr><td>SEQ NO</td>			<td>4 byte</td>	<td>未使用</td></tr>
 * <tr><td>ID</td>				<td>4 byte</td>	<td>5121</td></tr>
...
public class RFTId5121 extends SendIdMessage
{
	// Class field --------------------------------------------------
	/**
	 * 担当者コードのオフセット
	 ...
	 * ID番号
	 */
	public static final String ID = "5121";
