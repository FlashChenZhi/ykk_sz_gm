// $Id: IdmLocationInquiry.java,v 1.1.1.1 2006/08/17 09:34:09 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class IdmLocationInquiry extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Tab tab = jp.co.daifuku.bluedog.ui.control.TabFactory.getInstance("W_Query" , "W_Query");
	...
	public jp.co.daifuku.bluedog.ui.control.PullDown pul_Bank = jp.co.daifuku.bluedog.ui.control.PullDownFactory.getInstance("pul_Bank" , "W_IdmBank");
