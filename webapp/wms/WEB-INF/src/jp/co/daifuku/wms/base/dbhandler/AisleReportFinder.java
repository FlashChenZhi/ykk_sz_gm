//$Id: AisleReportFinder.java,v 1.2 2006/11/09 07:53:22 suresh Exp $
...
/**
 * This class searches the Aisle in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:22 $
 * @author  $Author: suresh $
 */
public class AisleReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public AisleReportFinder(Connection conn)
	{
		super(conn, Aisle.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:22 $") ;
	}
