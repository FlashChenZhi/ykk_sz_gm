// $Id: ListShippingQtyList.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListShippingQtyList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_ShippingDate = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_ShippingDate" , "W_ShippingDate");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ShpRsltLstOpt = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ShpRsltLstOpt" , "W_S_ShpRsltLstOpt");
