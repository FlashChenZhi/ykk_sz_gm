//$Id: TerminalAreaReportFinder.java,v 1.2 2006/11/09 07:50:25 suresh Exp $
...
/**
 * This class searches the Terminalarea in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:25 $
 * @author  $Author: suresh $
 */
public class TerminalAreaReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public TerminalAreaReportFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:25 $") ;
	}
