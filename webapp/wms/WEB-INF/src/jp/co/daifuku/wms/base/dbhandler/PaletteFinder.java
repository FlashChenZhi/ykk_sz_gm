//$Id: PaletteFinder.java,v 1.2 2006/11/09 07:51:42 suresh Exp $
...
/**
 * This class searches Palette in the database and maps with TestView
 ...
 */
public class PaletteFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public PaletteFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:42 $") ;
	}
