...
public class WorkStartStopSettingListProxy
{
	public WorkStartStopSettingListProxy(ListCell list)
	{
		this.list = list;
	}
	...
	public void setRowValueByEntity(WorkStartStopSettingEntity entity)
	{
		setCheck(true);
