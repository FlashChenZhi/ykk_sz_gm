// $Id: ListSortingQtyList.java,v 1.1.1.1 2006/08/17 09:34:32 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListSortingQtyList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.DateTextBox txt_F_Date = jp.co.daifuku.bluedog.ui.control.DateTextBoxFactory.getInstance("txt_F_Date" , "W_F_Date");
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_PickingRsltList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_PickingRsltList" , "W_PickingRsltList");
