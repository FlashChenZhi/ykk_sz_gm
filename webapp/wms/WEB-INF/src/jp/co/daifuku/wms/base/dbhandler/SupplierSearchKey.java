//$Id: SupplierSearchKey.java,v 1.2 2006/11/09 07:50:27 suresh Exp $
...
/**
 * This is the search key class for SUPPLIER use.
 *
...
public class SupplierSearchKey
		extends AbstractSQLSearchKey
{
	...
	{
		setValue(_Prefix + Supplier.CONSIGNORCODE.toString(), arg);
	}
	/**
	 *Set search value for  Consignor code
	...
	{
		setValue(_Prefix + Supplier.CONSIGNORCODE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Consignor code
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Supplier.CONSIGNORCODE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.CONSIGNORCODE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.CONSIGNORCODE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.CONSIGNORCODE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.CONSIGNORCODE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.SUPPLIERCODE.toString(), arg);
	}
	/**
	 *Set search value for  Supplier code
	 * @param arg String array
	...
	{
		setValue(_Prefix + Supplier.SUPPLIERCODE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Supplier code
	 * @param arg Set search value for String
	 ...
	 * @throws ReadWriteException if the format is abnormal
	 */
	public void setSupplierCode(String arg, String compcode, String left_paren, String right_paren,
	  String and_or)
	  throws ReadWriteException
	{
		setValue(_Prefix + Supplier.SUPPLIERCODE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.SUPPLIERCODE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.SUPPLIERCODE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.SUPPLIERCODE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.SUPPLIERCODE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.SUPPLIERNAME1.toString(), arg);
	}
	/**
	 *Set search value for  Supplier name
	 * @param arg String array
	...
	{
		setValue(_Prefix + Supplier.SUPPLIERNAME1.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Supplier name
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Supplier.SUPPLIERNAME1.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.SUPPLIERNAME1.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.SUPPLIERNAME1.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.SUPPLIERNAME1.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.SUPPLIERNAME1.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEDATE.toString(), arg);
	}
	/**
	 *Set search value for  Last update date
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEDATE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last update date
	 * @param arg Set search value for Date
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEDATE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.LASTUPDATEDATE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.LASTUPDATEDATE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUPDATEDATE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUPDATEDATE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEPNAME.toString(), arg);
	}
	/**
	 *Set search value for  Last update name
	 * @param arg String array
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEPNAME.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last update name
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Supplier.LASTUPDATEPNAME.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.LASTUPDATEPNAME.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.LASTUPDATEPNAME.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUPDATEPNAME.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUPDATEPNAME.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.LASTUSEDDATE.toString(), arg);
	}
	/**
	 *Set search value for  Last used date
	 * @param arg Date array
	...
	{
		setValue(_Prefix + Supplier.LASTUSEDDATE.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Last used date
	 * @param arg Set search value for Date
	...
	{
		setValue(_Prefix + Supplier.LASTUSEDDATE.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.LASTUSEDDATE.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.LASTUSEDDATE.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUSEDDATE.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.LASTUSEDDATE.toString(), compcode);
	}
	...
	{
		setValue(_Prefix + Supplier.DELETEFLAG.toString(), arg);
	}
	/**
	 *Set search value for  Delete flag
	 * @param arg String array
	...
	{
		setValue(_Prefix + Supplier.DELETEFLAG.toString(), arg, compcode);
	}
	/**
	 *Set search value for  Delete flag
	 * @param arg Set search value for String
	...
	{
		setValue(_Prefix + Supplier.DELETEFLAG.toString(), arg, compcode, left_paren, right_paren, and_or);
	}
	...
	{
		setOrder(_Prefix + Supplier.DELETEFLAG.toString(), num, bool);
	}
	...
	{
		setGroup(_Prefix + Supplier.DELETEFLAG.toString(), num);
	}
	...
	{
		setCollect(_Prefix + Supplier.DELETEFLAG.toString(), "");
	}
	...
	{
		setCollect(_Prefix + Supplier.DELETEFLAG.toString(), compcode);
	}
	...
	{
		return "$Id: SupplierSearchKey.java,v 1.2 2006/11/09 07:50:27 suresh Exp $" ;
	}
}
