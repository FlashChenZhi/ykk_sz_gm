...
public class StockoutStartListProxy
{
	public StockoutStartListProxy(ListCell list, Page page)
	{
		this.list = list;
		this.page = page;
	}
	...
	private int SUBDIVISION_COLUMN = 4;

	private int STOCKIN_TIME_COLUMN = 5;

	private int ITEM_CODE_COLUMN = 6;

	private int ITEM_NAME_1_COLUMN = 7;

	private int ITEM_NAME_2_COLUMN = 15;

	private int ITEM_NAME_3_COLUMN = 16;

	private int COLOR_COLUMN = 8;

	private int LOCATION_NO_COLUMN = 9;

	private int TICKET_NO_COLUMN = 10;
	...
	private int MCKEY_COLUMN = 14;

	private final String STOCKOUT_START_LIST = "STOCKOUT_START_LIST";

	public int getSUBDIVISION_COLUMN()
	{
		return SUBDIVISION_COLUMN;
	}
	...
	{
		return list.getValue(SUBDIVISION_COLUMN);
	}

	public void setSubdivision(String Subdivision)
	{
		list.setValue(SUBDIVISION_COLUMN, Subdivision);
	}
	...
	public StockoutStartEntity getStockoutStartEntity()
	{
		StockoutStartEntity entity = new StockoutStartEntity();

		entity.setU(getU());
		entity.setP(getP());
		entity.setSubDivide(getSubdivision());
	...
	public void setRowValueByEntity(StockoutStartEntity entity)
	{
		setU(entity.getU());
		setP(entity.getP());
		setSubdivision(entity.getSubdivision());
		...
		if (SystemIdSortableHandler.contain((ArrayList) page.getSession()
				.getAttribute(STOCKOUT_START_LIST), entity.getSystemId()))
		{
			setCheckBox(true);
		}
		else
