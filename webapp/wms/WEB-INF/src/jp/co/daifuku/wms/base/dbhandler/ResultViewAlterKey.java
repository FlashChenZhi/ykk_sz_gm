//$Id: ResultViewAlterKey.java,v 1.2 2006/11/09 07:51:36 suresh Exp $
...
/**
 * Update key class for DVRESULTVIEW use
 *
		...
		extends AbstractSQLAlterKey
{
	...
	{
		setUpdValue(_Prefix + ResultView.WORKDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.JOBNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.JOBTYPE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.COLLECTJOBNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.STATUSFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.BEGINNINGFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANUKEY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.STOCKID.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.AREANO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ZONENO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.LOCATIONNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.CONSIGNORCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.CONSIGNORNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SUPPLIERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SUPPLIERNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.INSTOCKTICKETNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.INSTOCKLINENO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.CUSTOMERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.CUSTOMERNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SHIPPINGTICKETNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SHIPPINGLINENO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ITEMCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ITEMNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.HOSTPLANQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANENABLEQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.RESULTQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SHORTAGECNT.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PENDINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.BUNDLEENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.CASEPIECEFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.WORKFORMFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ITF.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.BUNDLEITF.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.TCDCFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.USEBYDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.LOTNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANINFORMATION.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ORDERNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ORDERSEQNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.ORDERINGDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.RESULTUSEBYDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.RESULTLOTNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.RESULTLOCATIONNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.REPORTFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.BATCHNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.SYSTEMDISCKEY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.WORKERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.WORKERNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.TERMINALNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.PLANREGISTDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.REGISTDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.REGISTPNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.LASTUPDATEDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + ResultView.LASTUPDATEPNAME.toString(), arg);
	}
	...
	{
		return "$Id: ResultViewAlterKey.java,v 1.2 2006/11/09 07:51:36 suresh Exp $" ;
	}
}
