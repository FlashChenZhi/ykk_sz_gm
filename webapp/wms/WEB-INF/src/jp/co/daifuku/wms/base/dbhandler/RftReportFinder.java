//$Id: RftReportFinder.java,v 1.2 2006/11/09 07:50:46 suresh Exp $
...
/**
 * This class searches the Rft in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:46 $
 * @author  $Author: suresh $
 */
public class RftReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public RftReportFinder(Connection conn)
	{
		super(conn, Rft.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:46 $") ;
	}
