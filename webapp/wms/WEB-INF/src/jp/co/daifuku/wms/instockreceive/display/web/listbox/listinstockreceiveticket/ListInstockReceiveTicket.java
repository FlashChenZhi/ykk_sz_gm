// $Id: ListInstockReceiveTicket.java,v 1.1.1.1 2006/08/17 09:34:13 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListInstockReceiveTicket extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_TicketNoSearch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_TicketNoSearch" , "W_TicketNoSearch");
