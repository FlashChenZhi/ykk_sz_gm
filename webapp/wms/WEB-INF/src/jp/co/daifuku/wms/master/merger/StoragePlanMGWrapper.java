// $Id: StoragePlanMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $
...
public class StoragePlanMGWrapper
		extends MergerWrapper
{
	 ...
	 */
	public StoragePlanMGWrapper(Connection conn)
	...
	{
		if (ent instanceof StoragePlan)
		{
			StoragePlan aent = (StoragePlan)ent ;
	...
	{
		return "$Id: StoragePlanMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $" ;
	}
}
