 ...
 * Maker : S.Yoshida <BR>
 * <BR>
 * <CODE>MasterSortingParameter</CODE>クラスは、マスタパッケージ導入時の
 * 仕分パッケージ内の画面～スケジュール間のパラメータの受渡しに使用します。<BR>
 * <BR>
 * <DIR>
 * <CODE>MasterSortingParameter</CODE>クラスが保持する項目<BR>
 * <BR>
 *     補完タイプ<BR>
 * <BR>
 * <BR>
 ...
 * @author  $Author: mori $
 */
public class MasterSortingParameter extends jp.co.daifuku.wms.sorting.schedule.SortingParameter
{
	// Class feilds ------------------------------------------------
	/**
	 * 補完タイプ (すべて上書き)
