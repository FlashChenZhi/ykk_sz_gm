		...
		PendingTransferDataCencelOrPrioritize implements WMSConstants
{
	...
	public void btn_SelectAll_Click(ActionEvent e) throws Exception
	{
		ArrayList list = (ArrayList) session
				.getAttribute(PENDING_TRANSFER_DATA_CANCEL_OR_PRIORITIZE_LIST);
		for (int i = 1; i < lst_PendingTransferDataCencelO.getMaxRows(); i++)
		{
			lst_PendingTransferDataCencelO.setCurrentRow(i);
	...
	public void btn_UnselectAll_Click(ActionEvent e) throws Exception
	{
		...
		for (int i = 1; i < lst_PendingTransferDataCencelO.getMaxRows(); i++)
		{
			...
			if (listProxy.getSelected())
			{
				RetrievalPlankeySortableHandler.remove(list, listProxy
						.getPendingTransferDataCencelOrPrioritizeEntity());
