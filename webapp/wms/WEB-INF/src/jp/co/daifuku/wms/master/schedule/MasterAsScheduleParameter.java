 ...
 * Maker : S.Yoshida <BR>
 * <BR>
 * <CODE>MasterAsScheduleParameter</CODE>クラスは、マスタパッケージ導入時の
 * AS/RSパッケージ内の画面～スケジュール間のパラメータの受渡しに使用します。<BR>
 * <BR>
 * <DIR>
 * <CODE>MasterAsScheduleParameter</CODE>クラスが保持する項目<BR>
 * <BR>
 *     補完タイプ<BR>
 * <BR>
 * <BR>
 ...
 * @author  $Author: mori $
 */
public class MasterAsScheduleParameter extends jp.co.daifuku.wms.asrs.schedule.AsScheduleParameter
{
	// Class feilds ------------------------------------------------
	/**
	 * 補完タイプ (すべて上書き)
	 ...
	 * このクラスの初期化を行ないます。
	 */
	public MasterAsScheduleParameter()
	{
	}
