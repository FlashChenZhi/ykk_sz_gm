//$Id: PaletteReportFinder.java,v 1.2 2006/11/09 07:51:41 suresh Exp $
...
/**
 * This class searches the Palette in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:41 $
 * @author  $Author: suresh $
 */
public class PaletteReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public PaletteReportFinder(Connection conn)
	{
		super(conn, Palette.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:41 $") ;
	}
