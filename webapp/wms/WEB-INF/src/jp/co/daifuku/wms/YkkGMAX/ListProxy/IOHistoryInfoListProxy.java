...
public class IOHistoryInfoListProxy
{
	...
	private final int ITEM_NAME_2_COLUMN = 20;

	private final int ITEM_NAME_3_COLUMN = 21;
    ...
    private final int PRODUCT_START_DATE_COLUMN = 12;

    private final int LINE1_COLUMN = 13;

    private final int ORDER_NO_COLUMN = 14;

	private final int MEASURE_UNIT_WEIGHT_COLUMN = 15;

	private final int WORK_STATION_COLUMN = 16;

	private final int USER_ID_COLUMN = 17;

	private final int START_STATION_COLUMN = 18;

	private final int END_STATION_COLUMN = 19;

    public int getPRODUCT_START_DATE_COLUMN() {
        return PRODUCT_START_DATE_COLUMN;
    }

    public int getLINE1_COLUMN() {
        return LINE1_COLUMN;
    }
    ...
    {
        return list.getValue(PRODUCT_START_DATE_COLUMN);
    }

    public String getLine1()
    {
        return list.getValue(LINE1_COLUMN);
    }
			...
			throws YKKDBException, YKKSQLException
	{
		...
		try
		{
			...
			totalCount = centre.getBucketCount_head(head);
		}
		finally
		{
			if (conn != null)
    ...
    {
        list.setValue(PRODUCT_START_DATE_COLUMN, productStartDate);
    }

    public void setLine1(String line1)
    {
        list.setValue(LINE1_COLUMN, line1);
    }
	...
	public void setRowValueByEntity(IOHistoryInfoEntity entity, int rowNum)
	{
		...
		setProductStartDate(StringUtils.formatDateFromDBToPage(entity.getProductStartDate()));
