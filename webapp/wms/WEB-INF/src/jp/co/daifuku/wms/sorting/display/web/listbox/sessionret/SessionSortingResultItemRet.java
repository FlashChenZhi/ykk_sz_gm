 ...
 * <BR>
 * 1.検索処理(<CODE>SessionSortingResultItemRet(Connection conn,SortingParameter param)</CODE>メソッド)<BR>
 * <DIR>
...
public class SessionSortingResultItemRet extends SessionRet
{
	// Class fields --------------------------------------------------
	 ...
	 */
	public SessionSortingResultItemRet(Connection conn, SortingParameter param) throws Exception
	{
		this.wConn = conn;
		find(param);
	}
	...
	private void find(SortingParameter param) throws Exception
	{
		...
		{
			//仕分日
			skey.setWorkDate(param.getSortingDate());
		}
