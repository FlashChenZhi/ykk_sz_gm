...
public class EmptyBucketAddModeDiecastSettingRequestProcessor extends
	BasicProcessor
{
    private String mode = "";

    public EmptyBucketAddModeDiecastSettingRequestProcessor(String mode)
    {
	this.mode = mode;
    }
    ...
    {
	return "diecast_station_mode_change";
    }
