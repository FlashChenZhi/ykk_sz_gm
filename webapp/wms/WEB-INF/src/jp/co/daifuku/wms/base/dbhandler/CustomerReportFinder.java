//$Id: CustomerReportFinder.java,v 1.2 2006/11/09 07:53:10 suresh Exp $
...
/**
 * This class searches the Customer in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:10 $
 * @author  $Author: suresh $
 */
public class CustomerReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public CustomerReportFinder(Connection conn)
	{
		super(conn, Customer.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:10 $") ;
	}
