//$Id: WorkerResultReportFinder.java,v 1.2 2006/11/09 07:50:18 suresh Exp $
...
/**
 * This class searches the Workerresult in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:18 $
 * @author  $Author: suresh $
 */
public class WorkerResultReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public WorkerResultReportFinder(Connection conn)
	{
		super(conn, WorkerResult.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:18 $") ;
	}
