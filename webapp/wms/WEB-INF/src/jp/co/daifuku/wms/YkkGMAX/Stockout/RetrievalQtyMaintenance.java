 ...
 */
public class RetrievalQtyMaintenance extends Page
{

	// Class variables -----------------------------------------------
	public jp.co.daifuku.bluedog.ui.control.Label lbl_SettingName = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_SettingName" , "YKK_LBL_RetrievalQtyMaintenance");
	...
	public jp.co.daifuku.bluedog.ui.control.FreeTextBox txt_Item = jp.co.daifuku.bluedog.ui.control.FreeTextBoxFactory.getInstance("txt_Item" , "YKK_TXT_ItemNo_Enter");
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_Browse = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_Browse" , "YKK_BTN_ItemBrowse_POPUP");
	...
	public jp.co.daifuku.bluedog.ui.control.RadioButton rdo_Section = jp.co.daifuku.bluedog.ui.control.RadioButtonFactory.getInstance("rdo_Section" , "YKK_RDO_Section");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_TotalRetrievalQty = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_TotalRetrievalQty" , "YKK-LBL-TotalRetrievalQty");
	public jp.co.daifuku.bluedog.ui.control.Label lbl_TotalOutQty = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_TotalOutQty" , "YKK_LBL_TotalOutQty");
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_TotalRetrievalQty = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_TotalRetrievalQty" , "YKK_TXT_TotalRetrievalQty_RO");
	public jp.co.daifuku.bluedog.ui.control.Label lbl_MinusMark = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_MinusMark" , "YKK-LBL-MinusMark");
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_TotalOutQty = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_TotalOutQty" , "YKK_TXT_TotalOutQty_RO");
	...
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_RQMinusOQ = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_RQMinusOQ" , "YKK_TXT_RQMinusOQ_RO");
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_RetrievalQtyMaintenance = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_RetrievalQtyMaintenance" , "YKK_LST_RetrievalQtyMaintenance");
