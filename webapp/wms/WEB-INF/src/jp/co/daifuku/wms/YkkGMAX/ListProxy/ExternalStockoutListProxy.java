...
public class ExternalStockoutListProxy
{
	...
	private final int ITEM_CODE_COLUMN = 5;

	private final int ITEM_NAME_1_COLUMN = 6;

	private final int ITEM_NAME_2_COLUMN = 19;

	private final int ITEM_NAME_3_COLUMN = 20;

	private final int COLOR_COLUMN = 7;

	private final int STOCKOUT_NECESSARY_QTY_COLUMN = 8;

	private final int MANAGEMENT_RETRIEVAL_QTY_COLUMN = 9;

	private final int OUT_QTY_COLUMN = 10;

	private final int STOCKOUT_COUNT_COLUMN = 11;

	private final int ENABLE_TO_STOCKOUT_COUNT_COLUMN = 12;

	private final int TOTAL_COUNT_INSTOCK_COLUMN = 13;
	
	private final int WAVES_RETRIEVAL_QTY_COLUMN = 14;
	
	private final int EXTERNAL_CODE_COLUMN = 15;
