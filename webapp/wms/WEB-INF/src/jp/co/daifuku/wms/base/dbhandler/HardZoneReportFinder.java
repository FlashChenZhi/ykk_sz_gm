//$Id: HardZoneReportFinder.java,v 1.2 2006/11/09 07:53:06 suresh Exp $
...
/**
 * This class searches the Hardzone in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:06 $
 * @author  $Author: suresh $
 */
public class HardZoneReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public HardZoneReportFinder(Connection conn)
	{
		super(conn, HardZone.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:53:06 $") ;
	}
