 ...
 * <BR>
 * 1.検索処理(<CODE>SessionSortingWorkInfoConsignorRet(Connection conn,SortingParameter param)</CODE>メソッド)<BR>
 * <DIR>
 ...
 * @author  $Author: mori $
 */
public class SessionSortingWorkInfoConsignorRet extends SessionRet
{
	// Class fields --------------------------------------------------
	 ...
	 */
	public SessionSortingWorkInfoConsignorRet(Connection conn, SortingParameter param) throws Exception
	{
		this.wConn = conn;
		find(param);
	}
	 ...
	 */
	private SortingParameter[] convertToSortingParams(WorkingInformation[] workinfo)
	{
