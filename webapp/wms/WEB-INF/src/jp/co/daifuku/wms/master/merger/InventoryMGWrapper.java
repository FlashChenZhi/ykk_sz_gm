// $Id: InventoryMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $
...
public class InventoryMGWrapper
		extends MergerWrapper
{
	 ...
	 */
	public InventoryMGWrapper(Connection conn)
	...
	{
		if (ent instanceof InventoryCheck)
		{
			InventoryCheck aent = (InventoryCheck)ent ;
	...
	{
		return "$Id: InventoryMGWrapper.java,v 1.1.1.1 2006/08/17 09:34:19 mori Exp $" ;
	}
}
