//$Id: ResultViewReportFinder.java,v 1.2 2006/11/09 07:51:35 suresh Exp $
...
/**
 * This class searches the Dvresultview in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:35 $
 * @author  $Author: suresh $
 */
public class ResultViewReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ResultViewReportFinder(Connection conn)
	{
		super(conn, ResultView.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:35 $") ;
	}
