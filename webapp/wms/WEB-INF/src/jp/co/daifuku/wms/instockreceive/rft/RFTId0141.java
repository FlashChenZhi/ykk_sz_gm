// $Id: RFTId0141.java,v 1.1.1.1 2006/08/17 09:34:14 mori Exp $
...
/**
 * 出荷先単位入荷検品(TC)実績送信 ID=0141 電文を処理します
 * 
 * <p>
 * <table border="1">
 * <CAPTION>Id0141の電文の構造</CAPTION>
 * <TR><TH>項目名</TH>			<TH>長さ</TH>	<TH>内容</TH></TR>
 * <tr><td>STX</td>				<td>1 byte</td>	<td>0x02</td></tr>
 * <tr><td>SEQ No</td>			<td>4 byte</td>	<td>未使用</td></tr>
 * <tr><td>ID</td>				<td>4 byte</td>	<td>0141</td></tr>
 ...
 * @author  $Author: mori $
 */
public class RFTId0141 extends RecvIdMessage
{
	// Class fields --------------------------------------------------
	/**
	 * 作業者コードのオフセットの定義
	 ...
	 * 作業時間のオフセットの定義
	 */
	private static final int OFF_WORK_SECONDS = OFF_CUSTOMER_CODE + LEN_CUSTOMER_CODE;
	 ...
	 * ID番号
	 */
	public static final String ID = "0141";
	...
	/**
	 * 出荷先単位入荷検品実績送信電文から実績ファイル名称を取得します。
	 * @return		実績ファイル名称
	 */
	...
	/**
	 * 出荷先単位入荷検品実績送信電文からファイルレコード数を取得します。
	 * @return		ファイルレコード数
	 */
