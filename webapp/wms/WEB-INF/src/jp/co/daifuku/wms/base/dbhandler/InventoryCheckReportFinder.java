//$Id: InventoryCheckReportFinder.java,v 1.2 2006/11/09 07:52:55 suresh Exp $
...
/**
 * This class searches the Inventorycheck in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:52:55 $
 * @author  $Author: suresh $
 */
public class InventoryCheckReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public InventoryCheckReportFinder(Connection conn)
	{
		super(conn, InventoryCheck.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:52:55 $") ;
	}
