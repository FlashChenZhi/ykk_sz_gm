//$Id: SortingPlanAlterKey.java,v 1.2 2006/11/09 07:50:39 suresh Exp $
...
/**
 * Update key class for SORTINGPLAN use
 *
 ...
 * </tbody></table><hr>
 *
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:39 $
 * @author  ss
 * @author  Last commit: $Author: suresh $
 */


public class SortingPlanAlterKey
		extends AbstractSQLAlterKey
{
	...
	{
		setUpdValue(_Prefix + SortingPlan.SORTINGPLANUKEY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.STATUSFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.PLANDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.CONSIGNORCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.CONSIGNORNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.CUSTOMERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.CUSTOMERNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.SHIPPINGTICKETNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.SHIPPINGLINENO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.ITEMCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.ITEMNAME1.toString(), arg);
	}

	/**
	 * Set search value for Sorting plan qty
	 * @param arg Sorting plan qty<br>
	 * Set search value for Integer
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Sorting plan qty
	 * @param arg Update value for Sorting plan qty
	 */
	public void updatePlanQty(int arg)
	{
		setUpdValue(_Prefix + SortingPlan.PLANQTY.toString(), arg);
	}

	/**
	 * Set search value for Sorting result qty
	 * @param arg Sorting result qty<br>
	 * Set search value for Integer
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Sorting result qty
	 * @param arg Update value for Sorting result qty
	 */
	public void updateResultQty(int arg)
	{
		setUpdValue(_Prefix + SortingPlan.RESULTQTY.toString(), arg);
	}

	/**
	 * Set search value for Storage count
	 * @param arg Storage count<br>
	 * Set search value for Integer
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Storage count
	 * @param arg Update value for Storage count
	 */
	public void updateShortageCnt(int arg)
	{
		setUpdValue(_Prefix + SortingPlan.SHORTAGECNT.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.ENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.BUNDLEENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.CASEPIECEFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.ITF.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.BUNDLEITF.toString(), arg);
	}

	/**
	 * Set search value for Piece Sorting location
	 * @param arg Piece Sorting location<br>
	 * Set search value for String
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Piece Sorting location
	 * @param arg Update value for Piece Sorting location
	 */
	public void updatePieceLocation(String arg)
	{
		setUpdValue(_Prefix + SortingPlan.PIECELOCATION.toString(), arg);
	}

	/**
	 * Set search value for Case Sorting location
	 * @param arg Case Sorting location<br>
	 * Set search value for String
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Case Sorting location
	 * @param arg Update value for Case Sorting location
	 */
	public void updateCaseLocation(String arg)
	{
		setUpdValue(_Prefix + SortingPlan.CASELOCATION.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.TCDCFLAG.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.SUPPLIERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.SUPPLIERNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.INSTOCKTICKETNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.INSTOCKLINENO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.USEBYDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.LOTNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.PLANINFORMATION.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.BATCHNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.WORKERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.WORKERNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.TERMINALNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.REGISTKIND.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.REGISTDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.REGISTPNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.LASTUPDATEDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + SortingPlan.LASTUPDATEPNAME.toString(), arg);
	}
	...
	{
		return "$Id: SortingPlanAlterKey.java,v 1.2 2006/11/09 07:50:39 suresh Exp $" ;
	}
}
