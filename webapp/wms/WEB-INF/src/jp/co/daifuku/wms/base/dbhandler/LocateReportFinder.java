//$Id: LocateReportFinder.java,v 1.2 2006/11/09 07:51:51 suresh Exp $
...
/**
 * This class searches the Locate in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:51:51 $
 * @author  $Author: suresh $
 */
public class LocateReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public LocateReportFinder(Connection conn)
	{
		super(conn, Locate.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:51:51 $") ;
	}
