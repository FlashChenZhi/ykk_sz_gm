//$Id: ZoneFinder.java,v 1.2 2006/11/09 07:50:12 suresh Exp $
...
/**
 * This class searches Zone in the database and maps with TestView
 ...
 */
public class ZoneFinder extends AbstractDBFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ZoneFinder(Connection conn)
	{
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:12 $") ;
	}
