// $Id: ListShippingPlan.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListShippingPlan extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ShippingPlanSearch = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ShippingPlanSearch" , "W_ShippingPlanSearch");
