//$Id: InventoryCheckAlterKey.java,v 1.2 2006/11/09 07:52:56 suresh Exp $
...
/**
 * Update key class for INVENTORYCHECK use
 *
 ...
 * </tbody></table><hr>
 *
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:52:56 $
 * @author  ss
 * @author  Last commit: $Author: suresh $
 */


public class InventoryCheckAlterKey
		extends AbstractSQLAlterKey
{
	...
	{
		setUpdValue(_Prefix + InventoryCheck.JOBNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.STOCKID.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.AREANO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.LOCATIONNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.STATUSFLAG.toString(), arg);
	}

	/**
	 * Set search value for Inventory check barcode
	 * @param arg Inventory check barcode<br>
	 * Set search value for String
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Inventory check barcode
	 * @param arg Update value for Inventory check barcode
	 */
	public void updateInvcheckBcr(String arg)
	{
		setUpdValue(_Prefix + InventoryCheck.INVCHECKBCR.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.ITEMCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.ITEMNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.STOCKQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.ALLOCATIONQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.PLANQTY.toString(), arg);
	}

	/**
	 * Set search value for Result Stock qty
	 * @param arg Result Stock qty<br>
	 * Set search value for Integer
	 * @throws ReadWriteException if the format is abnormal
	 */
	...
	/**
	 * Set update value for Result Stock qty
	 * @param arg Update value for Result Stock qty
	 */
	public void updateResultStockQty(int arg)
	{
		setUpdValue(_Prefix + InventoryCheck.RESULTSTOCKQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.CASEPIECEFLAG.toString(), arg);
	}
	 ...
	 */
	public void updateInstockDate(String arg)
	{
		setUpdValue(_Prefix + InventoryCheck.INSTOCKDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.LASTSHIPPINGDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.USEBYDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.LOTNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.PLANINFORMATION.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.CONSIGNORCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.CONSIGNORNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.SUPPLIERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.SUPPLIERNAME1.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.ENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.BUNDLEENTERINGQTY.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.ITF.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.BUNDLEITF.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.WORKERCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.WORKERNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.TERMINALNO.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.REGISTDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.REGISTPNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.LASTUPDATEDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + InventoryCheck.LASTUPDATEPNAME.toString(), arg);
	}
	...
	{
		return "$Id: InventoryCheckAlterKey.java,v 1.2 2006/11/09 07:52:56 suresh Exp $" ;
	}
}
