//$Id: StoragePlanReportFinder.java,v 1.2 2006/11/09 07:50:29 suresh Exp $
...
/**
 * This class searches the Storageplan in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:50:29 $
 * @author  $Author: suresh $
 */
public class StoragePlanReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public StoragePlanReportFinder(Connection conn)
	{
		super(conn, StoragePlan.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.2 $,$Date: 2006/11/09 07:50:29 $") ;
	}
