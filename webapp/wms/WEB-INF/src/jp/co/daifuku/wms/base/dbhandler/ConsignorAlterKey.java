//$Id: ConsignorAlterKey.java,v 1.2 2006/11/09 07:53:13 suresh Exp $
...
/**
 * Update key class for CONSIGNOR use
 *
 ...
 * </tbody></table><hr>
 *
 * @version $Revision: 1.2 $, $Date: 2006/11/09 07:53:13 $
 * @author  ss
 * @author  Last commit: $Author: suresh $
 */


public class ConsignorAlterKey
		extends AbstractSQLAlterKey
{
	...
	{
		setUpdValue(_Prefix + Consignor.CONSIGNORCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Consignor.CONSIGNORNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Consignor.LASTUPDATEDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Consignor.LASTUPDATEPNAME.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Consignor.LASTUSEDDATE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Consignor.DELETEFLAG.toString(), arg);
	}
	...
	{
		return "$Id: ConsignorAlterKey.java,v 1.2 2006/11/09 07:53:13 suresh Exp $" ;
	}
}
