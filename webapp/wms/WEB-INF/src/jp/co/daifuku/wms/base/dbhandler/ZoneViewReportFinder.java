//$Id: ZoneViewReportFinder.java,v 1.3 2006/11/09 07:50:09 suresh Exp $
...
/**
 * This class searches the Dvzoneview in the database and map it with TestView
 ...
 * </TABLE>
 * <BR>
 * @version $Revision: 1.3 $, $Date: 2006/11/09 07:50:09 $
 * @author  $Author: suresh $
 */
public class ZoneViewReportFinder extends AbstractDBReportFinder
{
	// Class filelds -----------------------------------------------
	 ...
	 */
	public ZoneViewReportFinder(Connection conn)
	{
		super(conn, ZoneView.TABLE_NAME) ;
	}
	...
	{
		return ("$Revision: 1.3 $,$Date: 2006/11/09 07:50:09 $") ;
	}
