// $Id: InstockReceivePlanRegist2Business.java,v 1.1.1.1 2006/08/17 09:34:11 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class InstockReceivePlanRegist2Business extends InstockReceivePlanRegist2 implements WMSConstants
{
	...
	{
		// タイトル
		lbl_SettingName.setText(DisplayText.getText(this.getViewState().getString(InstockReceivePlanRegistBusiness.TITLE_KEY)));		
	...
	private InstockReceiveParameter[] setListParam(int lineno) throws Exception
	{
		...
		for (int i = 1; i < lst_SInstkRcvPlanRst.getMaxRows(); i++)
		{
			...
			// 入力エリア情報
			// 作業者コード
			param.setWorkerCode(this.getViewState().getString(InstockReceivePlanRegistBusiness.WORKERCODE));
			// パスワード
			param.setPassword(this.getViewState().getString(InstockReceivePlanRegistBusiness.PASSWORD));
			// 荷主コード
			...
			param.setTcdcFlag(this.getViewState().getString(InstockReceivePlanRegistBusiness.TCDCFLG));
			// 出荷先コード
	...
	/**
	 * TC/DC区分から対応する名称を取得します。<BR>
	 * <BR>
	 * @param str TC/DC区分(コード)
	 * @throws Exception 全ての例外を報告します。 
	 */
	...
	/**
	 * ためうちエリアのTC/DC区分から対応するパラメータを取得します。<BR>
	 * <BR>
	 * @param str TC/DC区分(名称)
	 * @throws Exception 全ての例外を報告します。 
	 */
	...
	public void btn_Input_Click(ActionEvent e) throws Exception
	{
		...
		// ケース入数
		txt_CaseEntering.validate(!Validator.isEmptyCheck(txt_HostCasePlanQty.getText()));
		// ホスト予定ケース数
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_EnterKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_TabKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_InputComplete(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_ColumClick(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_SInstkRcvPlanRst_Change(ActionEvent e) throws Exception
	{
	}
	...
	{
		this.getViewState().setString(InstockReceivePlanRegistBusiness.MESSAGE, "");
		// 詳細情報登録画面->基本情報設定画面
		forward(InstockReceivePlanRegistBusiness.DO_REGIST);
	}
}
//end of class
