// $Id: MasterInstockReceivePlanRegist2.java,v 1.1.1.1 2006/08/17 09:34:17 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class MasterInstockReceivePlanRegist2 extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_JavaSetSplNm = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_JavaSetSplNm" , "W_JavaSet");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_JavaSetTCDCFlag = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_JavaSetTCDCFlag" , "W_JavaSet");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_JavaSetTicketNo = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_JavaSetTicketNo" , "W_JavaSet");
	...
	public jp.co.daifuku.bluedog.ui.control.Label lbl_HostPiecePlanQty = jp.co.daifuku.bluedog.ui.control.LabelFactory.getInstance("lbl_HostPiecePlanQty" , "W_HostPiesePlanQty");
	public jp.co.daifuku.bluedog.ui.control.NumberTextBox txt_HostPiecePlanQty = jp.co.daifuku.bluedog.ui.control.NumberTextBoxFactory.getInstance("txt_HostPiecePlanQty" , "W_HostPiesePlanQty");
	...
	public jp.co.daifuku.bluedog.ui.control.SubmitButton btn_AllCancel = jp.co.daifuku.bluedog.ui.control.SubmitButtonFactory.getInstance("btn_AllCancel" , "W_AllCancel");
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_SInstkRcvPlanRst = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_SInstkRcvPlanRst" , "W_S_InstockReceivePlanRegist");
