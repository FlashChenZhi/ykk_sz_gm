 ...
 * Maker : S.Yoshida <BR>
 * <BR>
 * <CODE>MasterInstockReceiveParameter</CODE>クラスは、マスタパッケージ導入時の
 * 入荷パッケージ内の画面～スケジュール間のパラメータの受渡しに使用します。<BR>
 * <BR>
 * <DIR>
 * <CODE>MasterInstockReceiveParameter</CODE>クラスが保持する項目<BR>
 * <BR>
 *     補完タイプ<BR>
 * <BR>
 * <BR>
 ...
 * @author  $Author: mori $
 */
public class MasterInstockReceiveParameter extends jp.co.daifuku.wms.instockreceive.schedule.InstockReceiveParameter
{
	// Class feilds ------------------------------------------------
	/**
	 * 補完タイプ (すべて上書き)
	 ...
	 * このクラスの初期化を行ないます。
	 */
	public MasterInstockReceiveParameter()
	{
	}
