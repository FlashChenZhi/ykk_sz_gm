// $Id: ListShippingList.java,v 1.1.1.1 2006/08/17 09:34:28 mori Exp $
 ...
 * @author  $Author: mori $
 */
public class ListShippingList extends Page
{
	...
	public jp.co.daifuku.bluedog.ui.control.ListCell lst_ShippingWorkList = jp.co.daifuku.bluedog.ui.control.ListCellFactory.getInstance("lst_ShippingWorkList" , "W_ShippingWorkList");
