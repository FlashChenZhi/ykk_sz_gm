// $Id: ListSortingConsignorBusiness.java,v 1.1.1.1 2006/08/17 09:34:31 mori Exp $
 ...
 */
package jp.co.daifuku.wms.sorting.display.web.listbox.listsortingconsignor;
...
import jp.co.daifuku.wms.sorting.display.web.listbox.sessionret.SessionSortingPlanConsignorRet;
import jp.co.daifuku.wms.sorting.display.web.listbox.sessionret.SessionSortingResultConsignorRet;
import jp.co.daifuku.wms.sorting.display.web.listbox.sessionret.SessionSortingWorkInfoConsignorRet;
 ...
 * @author  $Author: mori $
 */
public class ListSortingConsignorBusiness extends ListSortingConsignor implements WMSConstants
{
	// Class fields --------------------------------------------------
	/** 
	 * 荷主コードの受け渡しに使用するキーです
	...
	public void page_Load(ActionEvent e) throws Exception
	{
		...
		// 検索する荷主が予定か実績か判断する
		if (searchconsignor.equals(SortingParameter.SEARCH_SORTING_PLAN))
		{
			// SessionSortingPlanConsignorRet インスタンス生成
			SessionSortingPlanConsignorRet listbox =
				new SessionSortingPlanConsignorRet(conn, param);
			// Sessionにlistboxを保持
			this.getSession().setAttribute("LISTBOX", listbox);
			setPlanList(listbox, "first");
		}
		else if (searchconsignor.equals(SortingParameter.SEARCH_SORTING_QTY))
		{
			// SessionSortingResultConsignorRet インスタンス生成
			SessionSortingResultConsignorRet listbox =
				new SessionSortingResultConsignorRet(conn, param);
			// Sessionにlistboxを保持
			this.getSession().setAttribute("LISTBOX", listbox);
			setResultList(listbox, "first");
		}
		else if (searchconsignor.equals(SortingParameter.SEARCH_SORTING_WORK))
		{
			// SessionSortingWorkInfoConsignorRet インスタンス生成
			SessionSortingWorkInfoConsignorRet listbox =
				new SessionSortingWorkInfoConsignorRet(conn, param);
			// Sessionにlistboxを保持
			this.getSession().setAttribute("LISTBOX", listbox);
	 ...
	 * @throws Exception 全ての例外を報告します。
	 */
	private void setPlanList(SessionSortingPlanConsignorRet listbox, String actionName)
		throws Exception
	{
		// ページ情報をセット
	 ...
	 * @throws Exception 全ての例外を報告します。
	 */
	private void setResultList(SessionSortingResultConsignorRet listbox, String actionName)
		throws Exception
	{
		// ページ情報をセット
		listbox.setActionName(actionName);
	 ...
	 * @throws Exception 全ての例外を報告します。
	 */
	private void setWorkList(SessionSortingWorkInfoConsignorRet listbox, String actionName)
		throws Exception
	{
		// ページ情報をセット
		listbox.setActionName(actionName);
	...
	public void pgr_D_Next(ActionEvent e) throws Exception
	{
		...
		if (flag.equals(SortingParameter.SEARCH_SORTING_PLAN))
		{
			// Sessionにlistboxを保持
			SessionSortingPlanConsignorRet listbox =
				(SessionSortingPlanConsignorRet) this.getSession().getAttribute("LISTBOX");
		...
		else if (flag.equals(SortingParameter.SEARCH_SORTING_QTY))
		{
			// Sessionにlistboxを保持
			SessionSortingResultConsignorRet listbox =
				(SessionSortingResultConsignorRet) this.getSession().getAttribute("LISTBOX");
		...
		else if (flag.equals(SortingParameter.SEARCH_SORTING_WORK))
		{
			// Sessionにlistboxを保持
			SessionSortingWorkInfoConsignorRet listbox =
				(SessionSortingWorkInfoConsignorRet) this.getSession().getAttribute("LISTBOX");
