 ...
 * @author  $Author: mori $
 */
public class MasterIdmNoPlanStorageSCH extends jp.co.daifuku.wms.idm.schedule.IdmNoPlanStorageSCH
{
	//	Class variables -----------------------------------------------
	 ...
	 * クラス名(予定外入庫)
	 */
	public static String PROCESSNAME = "MasterIdmNoPlanStorageSCH";
	 ...
	 * このクラスの初期化を行ないます。
	 */
	public MasterIdmNoPlanStorageSCH()
	{
		wMessage = null;
	}
	 ...
	 */
	public MasterIdmNoPlanStorageSCH(Connection conn) throws ReadWriteException, ScheduleException
	{
		wMessage = null;
	...
	{
		// 荷主初期表示設定を行います。
		IdmControlParameter tempParam = (IdmControlParameter) super.initFind(conn, searchParam);
		// 取得した荷主を返却パラメータにセットします。
		MasterIdmControlParameter wParam = new MasterIdmControlParameter();
		if (tempParam != null)
		{
	...
	public Parameter[] query(Connection conn, Parameter searchParam) throws ReadWriteException, ScheduleException
	{
		...
		MasterIdmControlParameter param = (MasterIdmControlParameter) searchParam;
		...
		if (stock != null)
		{
			MasterIdmControlParameter tempParam = (MasterIdmControlParameter) searchParam;
		...
		MasterIdmControlParameter[] result = new MasterIdmControlParameter[tempList.size()];
	...
	{
		// 入力エリアの内容
		MasterIdmControlParameter[] params = (MasterIdmControlParameter[]) startParams;
	 ...
	 * @throws ReadWriteException データベースとの接続で異常が発生した場合に通知されます。
	 */
	protected boolean checkModifyLastUpdateDate(MasterParameter param, MasterIdmControlParameter inputParam, int rowNo)
		...
		throws ReadWriteException
	{
		 ...
		 || masterPrefs.getMergeType() == MasterPrefs.MERGE_REGIST_TYPE_FILL_EMPTY)
		{
			...
			{
				// ケース/ピース区分がケースの場合
				if (casepieceflag.equals(IdmControlParameter.CASEPIECE_FLAG_CASE))
				{
				...
				// ケース/ピース区分が指定なしの場合
				else if (casepieceflag.equals(IdmControlParameter.CASEPIECE_FLAG_NOTHING))
				{
					// 入庫ケース数が1以上
					if (caseqty > 0)
					{
