//$Id: MachineAlterKey.java,v 1.3 2006/11/13 04:33:06 suresh Exp $
...
/**
 * Update key class for MACHINE use
 *
		...
		extends AbstractSQLAlterKey
{
	...
	{
		setUpdValue(_Prefix + Machine.STATIONNUMBER.toString(), arg);
	}

	/**
	 * Set search value for machine type
	 * @param arg machine type<br>
	...
	/**
	 * Set update value for machine type
	 * @param arg Update value for machine type
	 */
	public void updateMachineType(int arg)
	{
		setUpdValue(_Prefix + Machine.MACHINETYPE.toString(), arg);
	}
	 ...
	 */
	public void updateMachineNumber(int arg)
	{
		setUpdValue(_Prefix + Machine.MACHINENUMBER.toString(), arg);
	}
	 ...
	 */
	public void updateState(int arg)
	{
		setUpdValue(_Prefix + Machine.STATE.toString(), arg);
	}
	 ...
	 */
	public void updateErrorCode(String arg)
	{
		setUpdValue(_Prefix + Machine.ERRORCODE.toString(), arg);
	}
	...
	{
		setUpdValue(_Prefix + Machine.CONTROLLERNUMBER.toString(), arg);
	}
	...
	{
		return "$Id: MachineAlterKey.java,v 1.3 2006/11/13 04:33:06 suresh Exp $" ;
	}
}
