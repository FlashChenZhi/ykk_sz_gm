// $Id: StartStopAllSettingBusiness.java,v 1.1 2007/12/13 06:25:10 administrator Exp $
...
import jp.co.daifuku.wms.YkkGMAX.ListProxy.StartStopAllSettingListProxy;
import jp.co.daifuku.wms.YkkGMAX.Utils.ASRSInfoCentre;
import jp.co.daifuku.wms.YkkGMAX.Utils.ConnectionManager;
import jp.co.daifuku.wms.YkkGMAX.Utils.Debugprinter.DebugLevel;
import jp.co.daifuku.wms.YkkGMAX.Utils.Debugprinter.DebugPrinter;
import jp.co.daifuku.wms.YkkGMAX.resident.ProcessorInvoker;
import jp.co.daifuku.wms.YkkGMAX.resident.StartAllRequestProcessor;
import jp.co.daifuku.wms.YkkGMAX.resident.StopAllRequestProcessor;
 ...
 */
public class StartStopAllSettingBusiness extends StartStopAllSetting implements WMSConstants
{
	// Class fields --------------------------------------------------
	...
	private StartStopAllSettingListProxy listProxy = new StartStopAllSettingListProxy(lst_StartStopAllSetting);
	...
	{
		lst_StartStopAllSetting.clearRow();
		...
		try
		{
			...
			List startStopAllSettingList = centre.getStartStopAllSettingList();
			for(int i = 0 ; i < startStopAllSettingList.size() ; i++)
			{
				StartStopAllSettingEntity entity = (StartStopAllSettingEntity)startStopAllSettingList.get(i);
				
				lst_StartStopAllSetting.addRow();
				lst_StartStopAllSetting.setCurrentRow(lst_StartStopAllSetting.getMaxRows() - 1);
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_EnterKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_TabKey(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_InputComplete(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_ColumClick(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_Server(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_Change(ActionEvent e) throws Exception
	{
	}
	 ...
	 * @throws Exception 
	 */
	public void lst_StartStopAllSetting_Click(ActionEvent e) throws Exception
	{
	}
	...
	private void checkHasChecked()
	{
		...
		for (int i = 1; i < this.lst_StartStopAllSetting.getMaxRows(); i++)
		{
			lst_StartStopAllSetting.setCurrentRow(i);
	 ...
	 * @throws Exception 
	 */
	public void btn_Stop_Server(ActionEvent e) throws Exception
	{
		checkHasChecked();
		setConfirm("YKK-LBL-SetConfirm");
	 ...
	 * @throws Exception 
	 */
	public void btn_Stop_Click(ActionEvent e) throws Exception
	{
		InitDlg();
		checkHasChecked();
		setConfirm("YKK-LBL-SetConfirm");
	...
	public void page_ConfirmBack(ActionEvent e) throws Exception
	{
		...
		if (this.getViewState().getBoolean(DIALOG_FLAG1))
		{
			...
			pi.addProcessor(new StartAllRequestProcessor());
			pi.run();
		}
		else if (this.getViewState().getBoolean(DIALOG_FLAG2))
		{
			...
			message.setMsgResourceKey("7000034");
			ProcessorInvoker pi = new ProcessorInvoker(message);
			pi.addProcessor(new StopAllRequestProcessor());
			pi.run();
		}
