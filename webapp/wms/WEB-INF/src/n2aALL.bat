rem $Id: n2aALL.bat,v 1.3 2008/02/06 00:49:13 administrator Exp $
...
native2ascii -encoding ASCII log4j_windows.properties                            ../classes/log4j_windows.properties
native2ascii -encoding ASCII log4j_unix.properties                            ../classes/log4j_unix.properties