...
<xsl:template match="/template">
  ...
  <xsl:choose>
    ...
    <xsl:when test="count(list-items[@type='ListCellColumns']/list-item[@type='ListCellColumn'])>0">
      ...
      <!-- otput "OUTER TABLE" -->
      <xsl:if test="number(property[@name='fixedBank']/@value) &gt; number( 0 )">
        <xsl:text disable-output-escaping="yes"><![CDATA[<table border="0">]]></xsl:text>
        <xsl:text disable-output-escaping="yes"><![CDATA[<tr>]]></xsl:text>
        <xsl:text disable-output-escaping="yes"><![CDATA[<td align="left" >]]></xsl:text>
          <xsl:text disable-output-escaping="yes"><![CDATA[<img src="]]></xsl:text>
            <xsl:value-of select="$image_root"/>
            <xsl:text disable-output-escaping="yes"><![CDATA[1_1.gif]]></xsl:text>
          <xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
        <xsl:text disable-output-escaping="yes"><![CDATA[</td>]]></xsl:text>

        <xsl:text disable-output-escaping="yes"><![CDATA[<td align="right" >]]></xsl:text>
          <xsl:text disable-output-escaping="yes"><![CDATA[<img src="]]></xsl:text>
            <xsl:value-of select="$image_root"/>
            <xsl:text disable-output-escaping="yes"><![CDATA[1_1.gif]]></xsl:text>
          <xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text>
        ...
        <xsl:text disable-output-escaping="yes"><![CDATA[<td colspan="2">]]></xsl:text>
      </xsl:if>
