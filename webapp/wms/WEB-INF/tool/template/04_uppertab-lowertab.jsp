...
<td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#413a8a">
    <tr>
      ...
      <td height="24" align="right" style="padding-top : 1px;" 
    ...
    <tr>
      <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr bgcolor="#DAD9EE">
            <td nowrap bgcolor="#DAD9EE">XXX</td>
  ...
  <table border="0" cellspacing="0" cellpadding="0" style="margin-left:7">
    <tr>
      <td><img src="img/common/tab_urt3.gif" width="42" height="40" border="0"></td>
      <td bgcolor="#B8B7D7">
        <table width="80" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td></td>
      ...
      <td bgcolor="#B8B7D7"><img src="img/common/tab_ult3.gif" width="42" height="40" border="0"></td>
    </tr>
  </table>
  ...
  <table bgcolor="#B8B7D7" width="98%" border="0" cellspacing="0" cellpadding="0" style="margin-left:7">
    <tr>
      <td>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="#B8B7D7">
            <td nowrap bgcolor="#B8B7D7">XXX</td>
            <td bgcolor="#B8B7D7"><img src="img/common/icon_colon3.gif"></td>
             <td width="100%" bgcolor="#B8B7D7"></td>
          </tr>
          <tr bgcolor="#B8B7D7">
